...
#ifndef _LIBGL_SNAPSHOT_GLSNAPSHOT
#define _LIBGL_SNAPSHOT_GLSNAPSHOT

#include <map>
#include <string>
#include <vector>
#include <inttypes.h>
#include "emu_gles2/gl2.h"
...
namespace GLSnapshot {
    ...
    public:
        GLSnapshotState(const GLESv2Decoder *gl);
