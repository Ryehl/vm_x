...
//		if (opcode >= 2000 && opcode < 3000)
//		    ALOGD("xxx gles2-opcode = %d", opcode);
        switch (opcode) {
            case OP_glActiveTexture: {
                ...
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glActiveTexture\n", err);
#endif
            ...
            case OP_glAttachShader: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glAttachShader\n", err);
#endif
            ...
            case OP_glBindAttribLocation: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glBindAttribLocation\n",
                            err);
#endif
                DEBUG("gles2(%p): glBindAttribLocation(%u %u %p(%u) )\n", stream, var_program,
                      var_index, (const GLchar *) (inptr_name.get()), size_name);
                this->glBindAttribLocation_dec(this, var_program, var_index,
                                               (const GLchar *) (inptr_name.get()));
            ...
            case OP_glBindFramebuffer: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glBindFramebuffer\n", err);
#endif
            ...
            case OP_glBindRenderbuffer: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glBindRenderbuffer\n",
                            err);
#endif
            ...
            case OP_glBindTexture: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glBindTexture\n", err);
#endif
            ...
            case OP_glBlendEquation: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glBlendEquation\n", err);
#endif
            ...
            case OP_glBlendEquationSeparate: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glBlendEquationSeparate\n",
                            err);
#endif
            ...
            case OP_glBlendFuncSeparate: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glBlendFuncSeparate\n",
                            err);
#endif
            ...
            case OP_glBufferSubData: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glBufferSubData\n", err);
#endif
            ...
            case OP_glCheckFramebufferStatus: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glCheckFramebufferStatus\n", err);
#endif
            ...
            case OP_glClearDepthf: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glClearDepthf\n", err);
#endif
            ...
            case OP_glClearStencil: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glClearStencil\n", err);
#endif
            ...
            case OP_glCompileShader: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glCompileShader\n", err);
#endif
            ...
            case OP_glCompressedTexImage2D: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glCompressedTexImage2D\n",
                            err);
#endif
            ...
            case OP_glCompressedTexSubImage2D: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glCompressedTexSubImage2D\n", err);
#endif
            ...
            case OP_glCopyTexImage2D: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glCopyTexImage2D\n", err);
#endif
            ...
            case OP_glCopyTexSubImage2D: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glCopyTexSubImage2D\n",
                            err);
#endif
            ...
            case OP_glCreateProgram: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glCreateProgram\n", err);
#endif
            ...
            case OP_glCreateShader: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glCreateShader\n", err);
#endif
            ...
            case OP_glDeleteBuffers: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDeleteBuffers\n", err);
#endif
            ...
            case OP_glDeleteFramebuffers: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDeleteFramebuffers\n",
                            err);
#endif
                DEBUG("gles2(%p): glDeleteFramebuffers(%d %p(%u) )\n", stream, var_n,
                      (const GLuint *) (inptr_framebuffers.get()), size_framebuffers);
                this->glDeleteFramebuffers_dec(this, var_n,
            ...
            case OP_glDeleteProgram: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDeleteProgram\n", err);
#endif
            ...
            case OP_glDeleteRenderbuffers: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDeleteRenderbuffers\n",
                            err);
#endif
                DEBUG("gles2(%p): glDeleteRenderbuffers(%d %p(%u) )\n", stream, var_n,
                      (const GLuint *) (inptr_renderbuffers.get()), size_renderbuffers);
                this->glDeleteRenderbuffers_dec(this, var_n,
            ...
            case OP_glDeleteShader: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDeleteShader\n", err);
#endif
            ...
            case OP_glDeleteTextures: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDeleteTextures\n", err);
#endif
            ...
            case OP_glDepthRangef: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDepthRangef\n", err);
#endif
            ...
            case OP_glDetachShader: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDetachShader\n", err);
#endif
            ...
            case OP_glDisableVertexAttribArray: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glDisableVertexAttribArray\n",
                            err);
#endif
            ...
            case OP_glDrawElements: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDrawElements\n", err);
#endif
            ...
            case OP_glEnableVertexAttribArray: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glEnableVertexAttribArray\n", err);
#endif
            ...
            case OP_glFramebufferRenderbuffer: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glFramebufferRenderbuffer\n", err);
#endif
                ...
                this->glFramebufferRenderbuffer(var_target, var_attachment, var_renderbuffertarget,
                                                var_renderbuffer);
            ...
            case OP_glFramebufferTexture2D: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glFramebufferTexture2D\n",
                            err);
#endif
                ...
                this->glFramebufferTexture2D(var_target, var_attachment, var_textarget, var_texture,
                                             var_level);
            ...
            case OP_glGenerateMipmap: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGenerateMipmap\n", err);
#endif
            ...
            case OP_glGenFramebuffers: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGenFramebuffers\n", err);
#endif
            ...
            case OP_glGenRenderbuffers: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGenRenderbuffers\n",
                            err);
#endif
            ...
            case OP_glGenTextures: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGenTextures\n", err);
#endif
            ...
            case OP_glGetActiveAttrib: {
                ...
                uint32_t size_length __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4);
                uint32_t size_size __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4);
                uint32_t size_type __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4 + 4);
                uint32_t size_name __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4);
                if (useChecksum) {
                ...
                OutputBuffer outptr_name(&tmpBuf[0 + size_length + size_size + size_type],
                                         size_name);
#ifdef CHECK_GL_ERRORS
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetActiveAttrib\n", err);
#endif
                DEBUG("gles2(%p): glGetActiveAttrib(%u %u %d %p(%u) %p(%u) %p(%u) %p(%u) )\n",
                      stream, var_program, var_index, var_bufsize,
                      (GLsizei *) (outptr_length.get()), size_length, (GLint *) (outptr_size.get()),
                      size_size, (GLenum *) (outptr_type.get()), size_type,
                      (GLchar *) (outptr_name.get()), size_name);
                this->glGetActiveAttrib_dec(this, var_program, var_index, var_bufsize,
                                            size_length == 0 ? nullptr
                                                             : (GLsizei *) (outptr_length.get()),
                                            size_size == 0 ? nullptr
                                                           : (GLint *) (outptr_size.get()),
                                            size_type == 0 ? nullptr
                                                           : (GLenum *) (outptr_type.get()),
                                            size_name == 0 ? nullptr
                                                           : (GLchar *) (outptr_name.get()));
                outptr_length.flush();
                outptr_size.flush();
                outptr_type.flush();
                outptr_name.flush();
            ...
            case OP_glGetActiveUniform: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetActiveUniform\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetActiveUniform(%u %u %d %p(%u) %p(%u) %p(%u) %p(%u) )\n",
                      ...
                      size_size, (GLenum *) (outptr_type.get()), size_type,
                      (GLchar *) (outptr_name.get()), size_name);
                this->glGetActiveUniform_dec(this, var_program, var_index, var_bufsize,
                                             size_length == 0 ? nullptr
                                                              : (GLsizei *) (outptr_length.get()),
                                             size_size == 0 ? nullptr
                                                            : (GLint *) (outptr_size.get()),
            ...
            case OP_glGetAttachedShaders: {
                ...
                uint32_t size_count __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4);
                uint32_t size_shaders __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr, 8 + 4 + 4 + 4 + 4,
                                                             ptr + 8 + 4 + 4 + 4 + 4, checksumSize,
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetAttachedShaders\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetAttachedShaders(%u %d %p(%u) %p(%u) )\n", stream,
                      var_program, var_maxcount, (GLsizei *) (outptr_count.get()), size_count,
                      (GLuint *) (outptr_shaders.get()), size_shaders);
                this->glGetAttachedShaders_dec(this, var_program, var_maxcount,
                                               size_count == 0 ? nullptr
                                                               : (GLsizei *) (outptr_count.get()),
                                               (GLuint *) (outptr_shaders.get()));
                outptr_count.flush();
            ...
            case OP_glGetAttribLocation: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetAttribLocation\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetAttribLocation(%u %p(%u) )\n", stream, var_program,
                      (const GLchar *) (inptr_name.get()), size_name);
                *(int *) (&tmpBuf[0]) = this->glGetAttribLocation_dec(this, var_program,
                                                                      (const GLchar *) (inptr_name.get()));
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
                                                                totalTmpSize - checksumSize,
            ...
            case OP_glGetBooleanv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetBooleanv\n", err);
#endif
            ...
            case OP_glGetBufferParameteriv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetBufferParameteriv\n",
                            err);
#endif
            ...
            case OP_glGetFramebufferAttachmentParameteriv: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetFramebufferAttachmentParameteriv\n",
                            err);
#endif
                ...
                this->glGetFramebufferAttachmentParameteriv(var_target, var_attachment, var_pname,
                                                            (GLint *) (outptr_params.get()));
                outptr_params.flush();
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
            ...
            case OP_glGetIntegerv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetIntegerv\n", err);
#endif
            ...
            case OP_glGetProgramiv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetProgramiv\n", err);
#endif
                DEBUG("gles2(%p): glGetProgramiv(%u 0x%08x %p(%u) )\n", stream, var_program,
                      var_pname, (GLint *) (outptr_params.get()), size_params);
                this->glGetProgramiv_dec(this, var_program, var_pname,
                                         (GLint *) (outptr_params.get()));
                outptr_params.flush();
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
            ...
            case OP_glGetProgramInfoLog: {
                ...
                uint32_t size_length __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4);
                uint32_t size_infolog __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr, 8 + 4 + 4 + 4 + 4,
                                                             ptr + 8 + 4 + 4 + 4 + 4, checksumSize,
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetProgramInfoLog\n",
                            err);
#endif
                ALOGE("xxx glGetProgramInfoLog: %s", (GLchar *) (outptr_infolog.get()));
                DEBUG("gles2(%p): glGetProgramInfoLog(%u %d %p(%u) %p(%u) )\n", stream, var_program,
                      var_bufsize, (GLsizei *) (outptr_length.get()), size_length,
                      (GLchar *) (outptr_infolog.get()), size_infolog);
                this->glGetProgramInfoLog_dec(this, var_program, var_bufsize,
                                              size_length == 0 ? nullptr
                                                               : (GLsizei *) (outptr_length.get()),
                                              (GLchar *) (outptr_infolog.get()));
                outptr_length.flush();
            ...
            case OP_glGetRenderbufferParameteriv: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetRenderbufferParameteriv\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetRenderbufferParameteriv(0x%08x 0x%08x %p(%u) )\n", stream,
                      var_target, var_pname, (GLint *) (outptr_params.get()), size_params);
                this->glGetRenderbufferParameteriv(var_target, var_pname,
                                                   (GLint *) (outptr_params.get()));
                outptr_params.flush();
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
            ...
            case OP_glGetShaderiv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetShaderiv\n", err);
#endif
                DEBUG("gles2(%p): glGetShaderiv(%u 0x%08x %p(%u) )\n", stream, var_shader,
                      var_pname, (GLint *) (outptr_params.get()), size_params);
                this->glGetShaderiv_dec(this, var_shader, var_pname,
                                        (GLint *) (outptr_params.get()));
                outptr_params.flush();
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
            ...
            case OP_glGetShaderInfoLog: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetShaderInfoLog\n",
                            err);
#endif
                ALOGE("xxx glGetShaderInfoLog: %s", (GLchar *) (outptr_infolog.get()));
                DEBUG("gles2(%p): glGetShaderInfoLog(%u %d %p(%u) %p(%u) )\n", stream, var_shader,
                      var_bufsize, (GLsizei *) (outptr_length.get()), size_length,
                      (GLchar *) (outptr_infolog.get()), size_infolog);
                this->glGetShaderInfoLog_dec(this, var_shader, var_bufsize,
                                             size_length == 0 ? nullptr
                                                              : (GLsizei *) (outptr_length.get()),
                                             (GLchar *) (outptr_infolog.get()));
                outptr_length.flush();
            ...
            case OP_glGetShaderPrecisionFormat: {
                ...
                uint32_t size_range __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4);
                uint32_t size_precision __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr, 8 + 4 + 4 + 4 + 4,
                                                             ptr + 8 + 4 + 4 + 4 + 4, checksumSize,
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetShaderPrecisionFormat\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetShaderPrecisionFormat(0x%08x 0x%08x %p(%u) %p(%u) )\n",
                      stream, var_shadertype, var_precisiontype, (GLint *) (outptr_range.get()),
                      size_range, (GLint *) (outptr_precision.get()), size_precision);
                this->glGetShaderPrecisionFormat(var_shadertype, var_precisiontype,
                                                 (GLint *) (outptr_range.get()),
                                                 (GLint *) (outptr_precision.get()));
                outptr_range.flush();
            ...
            case OP_glGetShaderSource: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetShaderSource\n", err);
#endif
                DEBUG("gles2(%p): glGetShaderSource(%u %d %p(%u) %p(%u) )\n", stream, var_shader,
                      var_bufsize, (GLsizei *) (outptr_length.get()), size_length,
                      (GLchar *) (outptr_source.get()), size_source);
                this->glGetShaderSource_dec(this, var_shader, var_bufsize,
                                            size_length == 0 ? nullptr
                                                             : (GLsizei *) (outptr_length.get()),
                                            (GLchar *) (outptr_source.get()));
                outptr_length.flush();
                outptr_source.flush();
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
            ...
            case OP_glGetTexParameterfv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetTexParameterfv\n",
                            err);
#endif
            ...
            case OP_glGetTexParameteriv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetTexParameteriv\n",
                            err);
#endif
            ...
            case OP_glGetUniformfv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetUniformfv\n", err);
#endif
                DEBUG("gles2(%p): glGetUniformfv(%u %d %p(%u) )\n", stream, var_program,
                      var_location, (GLfloat *) (outptr_params.get()), size_params);
                this->glGetUniformfv_dec(this, var_program, var_location,
                                         (GLfloat *) (outptr_params.get()));
                outptr_params.flush();
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
                                                                totalTmpSize - checksumSize,
            ...
            case OP_glGetUniformiv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetUniformiv\n", err);
#endif
                DEBUG("gles2(%p): glGetUniformiv(%u %d %p(%u) )\n", stream, var_program,
                      var_location, (GLint *) (outptr_params.get()), size_params);
                this->glGetUniformiv_dec(this, var_program, var_location,
                                         (GLint *) (outptr_params.get()));
                outptr_params.flush();
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
            ...
            case OP_glGetUniformLocation: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetUniformLocation\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetUniformLocation(%u %p(%u) )\n", stream, var_program,
                      (const GLchar *) (inptr_name.get()), size_name);
                *(int *) (&tmpBuf[0]) = this->glGetUniformLocation_dec(this, var_program,
                                                                       (const GLchar *) (inptr_name.get()));
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
                                                                totalTmpSize - checksumSize,
            ...
            case OP_glGetVertexAttribfv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetVertexAttribfv\n",
                            err);
#endif
            ...
            case OP_glGetVertexAttribiv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetVertexAttribiv\n",
                            err);
#endif
            ...
            case OP_glGetVertexAttribPointerv: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetVertexAttribPointerv\n", err);
#endif
                DEBUG("gles2(%p): glGetVertexAttribPointerv(%u 0x%08x %p(%u) )\n", stream,
                      var_index, var_pname, (GLvoid **) (inptr_pointer.get()), size_pointer);
                this->glGetVertexAttribPointerv(var_index, var_pname,
                                                (GLvoid **) (inptr_pointer.get()));
            ...
            case OP_glIsFramebuffer: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glIsFramebuffer\n", err);
#endif
            ...
            case OP_glIsRenderbuffer: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glIsRenderbuffer\n", err);
#endif
            ...
            case OP_glLinkProgram: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glLinkProgram\n", err);
#endif
            ...
            case OP_glPixelStorei: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glPixelStorei\n", err);
#endif
            ...
            case OP_glPolygonOffset: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glPolygonOffset\n", err);
#endif
            ...
            case OP_glReleaseShaderCompiler: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glReleaseShaderCompiler\n",
                            err);
#endif
            ...
            case OP_glRenderbufferStorage: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glRenderbufferStorage\n",
                            err);
#endif
            ...
            case OP_glSampleCoverage: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glSampleCoverage\n", err);
#endif
            ...
            case OP_glShaderBinary: {
                ...
                uint32_t size_binary __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + size_shaders + 4);
                InputBuffer inptr_binary(ptr + 8 + 4 + 4 + size_shaders + 4 + 4, size_binary);
                GLsizei var_length = Unpack<GLsizei, uint32_t>(
                        ptr + 8 + 4 + 4 + size_shaders + 4 + 4 + size_binary);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + size_shaders + 4 + 4 +
                                                             size_binary + 4,
                                                             ptr + 8 + 4 + 4 + size_shaders + 4 +
                                                             4 + size_binary + 4, checksumSize,
                                                             "gles2_decoder_context_t::decode, OP_glShaderBinary: GL checksumCalculator failure\n");
                }
#ifdef CHECK_GL_ERRORS
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glShaderBinary\n", err);
#endif
                DEBUG("gles2(%p): glShaderBinary(%d %p(%u) 0x%08x %p(%u) %d )\n", stream, var_n,
                      (const GLuint *) (inptr_shaders.get()), size_shaders, var_binaryformat,
                      (const GLvoid *) (inptr_binary.get()), size_binary, var_length);
                this->glShaderBinary(var_n, (const GLuint *) (inptr_shaders.get()),
                                     var_binaryformat, (const GLvoid *) (inptr_binary.get()),
                                     var_length);
            ...
            case OP_glShaderSource: {
                GLuint var_shader = Unpack<GLuint, uint32_t>(ptr + 8);
                GLsizei var_count = Unpack<GLsizei, uint32_t>(ptr + 8 + 4);
                uint32_t size_string __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4);
                InputBuffer inptr_string(ptr + 8 + 4 + 4 + 4, size_string);
                uint32_t size_length __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + size_string);
                InputBuffer inptr_length(ptr + 8 + 4 + 4 + 4 + size_string + 4, size_length);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + size_string + 4 +
                                                             size_length,
                                                             ptr + 8 + 4 + 4 + 4 + size_string + 4 +
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glShaderSource\n", err);
#endif
                DEBUG("gles2(%p): glShaderSource(%u %d %p(%u) %p(%u) )\n", stream, var_shader,
                      var_count, (const GLchar *const *) (inptr_string.get()), size_string,
                      (const GLint *) (inptr_length.get()), size_length);
                this->glShaderSource(var_shader, var_count,
                                     (const GLchar *const *) (inptr_string.get()),
                                     (const GLint *) (inptr_length.get()));
            ...
            case OP_glStencilFunc: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glStencilFunc\n", err);
#endif
            ...
            case OP_glStencilFuncSeparate: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glStencilFuncSeparate\n",
                            err);
#endif
                DEBUG("gles2(%p): glStencilFuncSeparate(0x%08x 0x%08x %d %u )\n", stream, var_face,
                      var_func, var_ref, var_mask);
            ...
            case OP_glStencilMask: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glStencilMask\n", err);
#endif
            ...
            case OP_glStencilMaskSeparate: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glStencilMaskSeparate\n",
                            err);
#endif
            ...
            case OP_glStencilOpSeparate: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glStencilOpSeparate\n",
                            err);
#endif
                DEBUG("gles2(%p): glStencilOpSeparate(0x%08x 0x%08x 0x%08x 0x%08x )\n", stream,
                      var_face, var_fail, var_zfail, var_zpass);
            ...
            case OP_glTexParameterf: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glTexParameterf\n", err);
#endif
            ...
            case OP_glTexParameterfv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glTexParameterfv\n", err);
#endif
            ...
            case OP_glTexParameteri: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glTexParameteri\n", err);
#endif
            ...
            case OP_glTexParameteriv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glTexParameteriv\n", err);
#endif
            ...
            case OP_glTexSubImage2D: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glTexSubImage2D\n", err);
#endif
            ...
            case OP_glUniform1fv: {
                GLint var_location = Unpack<GLint, uint32_t>(ptr + 8);
                GLsizei var_count = Unpack<GLsizei, uint32_t>(ptr + 8 + 4);
                uint32_t size_v __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4);
...
#endif
                DEBUG("gles2(%p): glUniform1fv(%d %d %p(%u) )\n", stream, var_location, var_count,
                      (const GLfloat *) (inptr_v.get()), size_v);
            ...
            case OP_glUniform1iv: {
                ...
                DEBUG("gles2(%p): glUniform1iv(%d %d %p(%u) )\n", stream, var_location, var_count,
                      (const GLint *) (inptr_v.get()), size_v);
            ...
            case OP_glUniformMatrix2fv: {
                ...
                uint32_t size_value __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 1);
                InputBuffer inptr_value(ptr + 8 + 4 + 4 + 1 + 4, size_value);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 1 + 4 + size_value,
                                                             ptr + 8 + 4 + 4 + 1 + 4 + size_value,
                                                             checksumSize,
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glUniformMatrix2fv\n",
                            err);
#endif
                DEBUG("gles2(%p): glUniformMatrix2fv(%d %d %d %p(%u) )\n", stream, var_location,
                      var_count, var_transpose, (const GLfloat *) (inptr_value.get()), size_value);
                this->glUniformMatrix2fv(var_location, var_count, var_transpose,
                                         (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glUniformMatrix3fv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glUniformMatrix3fv\n",
                            err);
#endif
                DEBUG("gles2(%p): glUniformMatrix3fv(%d %d %d %p(%u) )\n", stream, var_location,
                      var_count, var_transpose, (const GLfloat *) (inptr_value.get()), size_value);
                this->glUniformMatrix3fv(var_location, var_count, var_transpose,
                                         (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glUniformMatrix4fv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glUniformMatrix4fv\n",
                            err);
#endif
                DEBUG("gles2(%p): glUniformMatrix4fv(%d %d %d %p(%u) )\n", stream, var_location,
                      var_count, var_transpose, (const GLfloat *) (inptr_value.get()), size_value);
                this->glUniformMatrix4fv(var_location, var_count, var_transpose,
                                         (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glValidateProgram: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glValidateProgram\n", err);
#endif
            ...
            case OP_glVertexAttrib1f: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glVertexAttrib1f\n", err);
#endif
            ...
            case OP_glVertexAttrib1fv: {
                GLuint var_indx = Unpack<GLuint, uint32_t>(ptr + 8);
                uint32_t size_values __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4);
                InputBuffer inptr_values(ptr + 8 + 4 + 4, size_values);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + size_values,
                                                             ptr + 8 + 4 + 4 + size_values,
                                                             checksumSize,
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glVertexAttrib1fv\n", err);
#endif
                DEBUG("gles2(%p): glVertexAttrib1fv(%u %p(%u) )\n", stream, var_indx,
                      (const GLfloat *) (inptr_values.get()), size_values);
            ...
            case OP_glVertexAttrib2f: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glVertexAttrib2f\n", err);
#endif
            ...
            case OP_glVertexAttrib2fv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glVertexAttrib2fv\n", err);
#endif
            ...
            case OP_glVertexAttrib3f: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glVertexAttrib3f\n", err);
#endif
            ...
            case OP_glVertexAttrib3fv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glVertexAttrib3fv\n", err);
#endif
            ...
            case OP_glVertexAttrib4f: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glVertexAttrib4f\n", err);
#endif
            ...
            case OP_glVertexAttrib4fv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glVertexAttrib4fv\n", err);
#endif
            ...
            case OP_glVertexAttribPointer: {
                ...
                uint32_t size_ptr __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 1 + 4);
                InputBuffer inptr_ptr(ptr + 8 + 4 + 4 + 4 + 1 + 4 + 4, size_ptr);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + 1 + 4 + 4 + size_ptr,
                                                             ptr + 8 + 4 + 4 + 4 + 1 + 4 + 4 +
                                                             size_ptr, checksumSize,
                                                             "gles2_decoder_context_t::decode, OP_glVertexAttribPointer: GL checksumCalculator failure\n");
                }
#ifdef CHECK_GL_ERRORS
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glVertexAttribPointer\n",
                            err);
#endif
                DEBUG("gles2(%p): glVertexAttribPointer(%u %d 0x%08x %d %d %p(%u) )\n", stream,
                      var_indx, var_size, var_type, var_normalized, var_stride,
                      (const GLvoid *) (inptr_ptr.get()), size_ptr);
                this->glVertexAttribPointer(var_indx, var_size, var_type, var_normalized,
                                            var_stride, (const GLvoid *) (inptr_ptr.get()));
            ...
            case OP_glEGLImageTargetTexture2DOES: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glEGLImageTargetTexture2DOES\n",
                            err);
#endif
            ...
            case OP_glEGLImageTargetRenderbufferStorageOES: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glEGLImageTargetRenderbufferStorageOES\n",
                            err);
#endif
            ...
            case OP_glGetProgramBinaryOES: {
                ...
                uint32_t size_binaryFormat __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + size_length);
                InputBuffer inptr_binaryFormat(ptr + 8 + 4 + 4 + 4 + size_length + 4,
                                               size_binaryFormat);
                uint32_t size_binary __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + size_length + 4 + size_binaryFormat);
                InputBuffer inptr_binary(
                        ptr + 8 + 4 + 4 + 4 + size_length + 4 + size_binaryFormat + 4, size_binary);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + size_length + 4 +
                                                             size_binaryFormat + 4 + size_binary,
                                                             ptr + 8 + 4 + 4 + 4 + size_length + 4 +
                                                             size_binaryFormat + 4 + size_binary,
                                                             checksumSize,
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetProgramBinaryOES\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetProgramBinaryOES(%u %d %p(%u) %p(%u) %p(%u) )\n", stream,
                      var_program, var_bufSize, (GLsizei *) (inptr_length.get()), size_length,
                      (GLenum *) (inptr_binaryFormat.get()), size_binaryFormat,
                      (GLvoid *) (inptr_binary.get()), size_binary);
                this->glGetProgramBinaryOES_dec(this, var_program, var_bufSize,
                                                (GLsizei *) (inptr_length.get()),
                                                (GLenum *) (inptr_binaryFormat.get()),
                                                (GLvoid *) (inptr_binary.get()));
            ...
            case OP_glProgramBinaryOES: {
                ...
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + size_binary + 4,
                                                             ptr + 8 + 4 + 4 + 4 + size_binary + 4,
                                                             checksumSize,
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramBinaryOES\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramBinaryOES(%u 0x%08x %p(%u) %d )\n", stream, var_program,
                      var_binaryFormat, (const GLvoid *) (inptr_binary.get()), size_binary,
                      var_length);
                this->glProgramBinaryOES_dec(this, var_program, var_binaryFormat,
                                             (const GLvoid *) (inptr_binary.get()), var_length);
            ...
            case OP_glMapBufferOES: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glMapBufferOES\n", err);
#endif
            ...
            case OP_glUnmapBufferOES: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glUnmapBufferOES\n", err);
#endif
            ...
            case OP_glTexImage3DOES: {
                ...
                InputBuffer inptr_pixels(ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4,
                                         size_pixels);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 +
                                                             4 + size_pixels,
                                                             ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 +
                                                             4 + 4 + 4 + size_pixels, checksumSize,
                                                             "gles2_decoder_context_t::decode, OP_glTexImage3DOES: GL checksumCalculator failure\n");
                }
#ifdef CHECK_GL_ERRORS
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glTexImage3DOES\n", err);
#endif
                DEBUG("gles2(%p): glTexImage3DOES(0x%08x %d 0x%08x %d %d %d %d 0x%08x 0x%08x %p(%u) )\n",
                      stream, var_target, var_level, var_internalformat, var_width, var_height,
                      var_depth, var_border, var_format, var_type,
                      (const GLvoid *) (inptr_pixels.get()), size_pixels);
                this->glTexImage3DOES(var_target, var_level, var_internalformat, var_width,
                                      var_height, var_depth, var_border, var_format, var_type,
                                      size_pixels == 0 ? nullptr
                                                       : (const GLvoid *) (inptr_pixels.get()));
            ...
            case OP_glTexSubImage3DOES: {
                ...
                InputBuffer inptr_pixels(ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4,
                                         size_pixels);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 +
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glTexSubImage3DOES\n",
                            err);
#endif
                DEBUG("gles2(%p): glTexSubImage3DOES(0x%08x %d %d %d %d %d %d %d 0x%08x 0x%08x %p(%u) )\n",
                      ...
                      (const GLvoid *) (inptr_pixels.get()), size_pixels);
                this->glTexSubImage3DOES(var_target, var_level, var_xoffset, var_yoffset,
                                         var_zoffset, var_width, var_height, var_depth, var_format,
                                         var_type, size_pixels == 0 ? nullptr
                                                                    : (const GLvoid *) (inptr_pixels.get()));
            ...
            case OP_glCopyTexSubImage3DOES: {
                ...
                GLsizei var_height = Unpack<GLsizei, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4,
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glCopyTexSubImage3DOES\n",
                            err);
#endif
                DEBUG("gles2(%p): glCopyTexSubImage3DOES(0x%08x %d %d %d %d %d %d %d %d )\n",
                      stream, var_target, var_level, var_xoffset, var_yoffset, var_zoffset, var_x,
                      var_y, var_width, var_height);
                this->glCopyTexSubImage3DOES(var_target, var_level, var_xoffset, var_yoffset,
                                             var_zoffset, var_x, var_y, var_width, var_height);
            ...
            case OP_glCompressedTexImage3DOES: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glCompressedTexImage3DOES\n", err);
#endif
                DEBUG("gles2(%p): glCompressedTexImage3DOES(0x%08x %d 0x%08x %d %d %d %d %d %p(%u) )\n",
                      stream, var_target, var_level, var_internalformat, var_width, var_height,
                      var_depth, var_border, var_imageSize, (const GLvoid *) (inptr_data.get()),
                      size_data);
                this->glCompressedTexImage3DOES(var_target, var_level, var_internalformat,
                                                var_width, var_height, var_depth, var_border,
                                                var_imageSize, size_data == 0 ? nullptr
                                                                              : (const GLvoid *) (inptr_data.get()));
            ...
            case OP_glCompressedTexSubImage3DOES: {
                ...
                uint32_t size_data __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4);
                InputBuffer inptr_data(ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4,
                                       size_data);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 +
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glCompressedTexSubImage3DOES\n",
                            err);
#endif
                DEBUG("gles2(%p): glCompressedTexSubImage3DOES(0x%08x %d %d %d %d %d %d %d 0x%08x %d %p(%u) )\n",
                      stream, var_target, var_level, var_xoffset, var_yoffset, var_zoffset,
                      var_width, var_height, var_depth, var_format, var_imageSize,
                      (const GLvoid *) (inptr_data.get()), size_data);
                this->glCompressedTexSubImage3DOES(var_target, var_level, var_xoffset, var_yoffset,
                                                   var_zoffset, var_width, var_height, var_depth,
                                                   var_format, var_imageSize,
                                                   size_data == 0 ? nullptr
                                                                  : (const GLvoid *) (inptr_data.get()));
            ...
            case OP_glFramebufferTexture3DOES: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glFramebufferTexture3DOES\n", err);
#endif
                DEBUG("gles2(%p): glFramebufferTexture3DOES(0x%08x 0x%08x 0x%08x %u %d %d )\n",
                      ...
                      var_zoffset);
                this->glFramebufferTexture3DOES(var_target, var_attachment, var_textarget,
                                                var_texture, var_level, var_zoffset);
            ...
            case OP_glBindVertexArrayOES: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glBindVertexArrayOES\n",
                            err);
#endif
            ...
            case OP_glDeleteVertexArraysOES: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDeleteVertexArraysOES\n",
                            err);
#endif
            ...
            case OP_glGenVertexArraysOES: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGenVertexArraysOES\n",
                            err);
#endif
            ...
            case OP_glIsVertexArrayOES: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glIsVertexArrayOES\n",
                            err);
#endif
            ...
            case OP_glDiscardFramebufferEXT: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDiscardFramebufferEXT\n",
                            err);
#endif
            ...
            case OP_glMultiDrawArraysEXT: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glMultiDrawArraysEXT\n",
                            err);
#endif
            ...
            case OP_glMultiDrawElementsEXT: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glMultiDrawElementsEXT\n",
                            err);
#endif
            ...
            case OP_glGetPerfMonitorGroupsAMD: {
                uint32_t size_numGroups __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8);
                InputBuffer inptr_numGroups(ptr + 8 + 4, size_numGroups);
                GLsizei var_groupsSize = Unpack<GLsizei, uint32_t>(ptr + 8 + 4 + size_numGroups);
                uint32_t size_groups __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + size_numGroups + 4);
                InputBuffer inptr_groups(ptr + 8 + 4 + size_numGroups + 4 + 4, size_groups);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + size_numGroups + 4 + 4 +
                                                             size_groups,
                                                             ptr + 8 + 4 + size_numGroups + 4 + 4 +
                                                             size_groups, checksumSize,
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetPerfMonitorGroupsAMD\n", err);
#endif
                DEBUG("gles2(%p): glGetPerfMonitorGroupsAMD(%p(%u) %d %p(%u) )\n", stream,
                      (GLint *) (inptr_numGroups.get()), size_numGroups, var_groupsSize,
                      (GLuint *) (inptr_groups.get()), size_groups);
                this->glGetPerfMonitorGroupsAMD((GLint *) (inptr_numGroups.get()), var_groupsSize,
                                                (GLuint *) (inptr_groups.get()));
                SET_LASTCALL("glGetPerfMonitorGroupsAMD");
                break;
            }
            case OP_glGetPerfMonitorCountersAMD: {
                GLuint var_group = Unpack<GLuint, uint32_t>(ptr + 8);
                uint32_t size_numCounters __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4);
                InputBuffer inptr_numCounters(ptr + 8 + 4 + 4, size_numCounters);
                uint32_t size_maxActiveCounters __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + size_numCounters);
                InputBuffer inptr_maxActiveCounters(ptr + 8 + 4 + 4 + size_numCounters + 4,
                                                    size_maxActiveCounters);
                GLsizei var_counterSize = Unpack<GLsizei, uint32_t>(
                        ptr + 8 + 4 + 4 + size_numCounters + 4 + size_maxActiveCounters);
                uint32_t size_counters __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + size_numCounters + 4 + size_maxActiveCounters + 4);
                InputBuffer inptr_counters(
                        ptr + 8 + 4 + 4 + size_numCounters + 4 + size_maxActiveCounters + 4 + 4,
                        size_counters);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + size_numCounters + 4 +
                                                             size_maxActiveCounters + 4 + 4 +
                                                             size_counters,
                                                             ptr + 8 + 4 + 4 + size_numCounters +
                                                             4 + size_maxActiveCounters + 4 + 4 +
                                                             size_counters, checksumSize,
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetPerfMonitorCountersAMD\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetPerfMonitorCountersAMD(%u %p(%u) %p(%u) %d %p(%u) )\n",
                      stream, var_group, (GLint *) (inptr_numCounters.get()), size_numCounters,
                      (GLint *) (inptr_maxActiveCounters.get()), size_maxActiveCounters,
                      var_counterSize, (GLuint *) (inptr_counters.get()), size_counters);
                this->glGetPerfMonitorCountersAMD(var_group, (GLint *) (inptr_numCounters.get()),
                                                  (GLint *) (inptr_maxActiveCounters.get()),
                                                  var_counterSize,
                                                  (GLuint *) (inptr_counters.get()));
            ...
            case OP_glGetPerfMonitorGroupStringAMD: {
                ...
                uint32_t size_length __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4);
                InputBuffer inptr_length(ptr + 8 + 4 + 4 + 4, size_length);
                uint32_t size_groupString __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + size_length);
                InputBuffer inptr_groupString(ptr + 8 + 4 + 4 + 4 + size_length + 4,
                                              size_groupString);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + size_length + 4 +
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetPerfMonitorGroupStringAMD\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetPerfMonitorGroupStringAMD(%u %d %p(%u) %p(%u) )\n", stream,
                      var_group, var_bufSize, (GLsizei *) (inptr_length.get()), size_length,
                      (GLchar *) (inptr_groupString.get()), size_groupString);
                this->glGetPerfMonitorGroupStringAMD(var_group, var_bufSize,
                                                     (GLsizei *) (inptr_length.get()),
                                                     (GLchar *) (inptr_groupString.get()));
            ...
            case OP_glGetPerfMonitorCounterStringAMD: {
                ...
                uint32_t size_counterString __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4 + size_length);
                InputBuffer inptr_counterString(ptr + 8 + 4 + 4 + 4 + 4 + size_length + 4,
                                                size_counterString);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + 4 + size_length + 4 +
                                                             size_counterString,
                                                             ptr + 8 + 4 + 4 + 4 + 4 + size_length +
                                                             4 + size_counterString, checksumSize,
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetPerfMonitorCounterStringAMD\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetPerfMonitorCounterStringAMD(%u %u %d %p(%u) %p(%u) )\n",
                      stream, var_group, var_counter, var_bufSize, (GLsizei *) (inptr_length.get()),
                      size_length, (GLchar *) (inptr_counterString.get()), size_counterString);
                this->glGetPerfMonitorCounterStringAMD(var_group, var_counter, var_bufSize,
                                                       (GLsizei *) (inptr_length.get()),
                                                       (GLchar *) (inptr_counterString.get()));
            ...
            case OP_glGenPerfMonitorsAMD: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGenPerfMonitorsAMD\n",
                            err);
#endif
                DEBUG("gles2(%p): glGenPerfMonitorsAMD(%d %p(%u) )\n", stream, var_n,
                      (GLuint *) (inptr_monitors.get()), size_monitors);
            ...
            case OP_glDeletePerfMonitorsAMD: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDeletePerfMonitorsAMD\n",
                            err);
#endif
            ...
            case OP_glSelectPerfMonitorCountersAMD: {
                ...
                uint32_t size_countersList __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 1 + 4 + 4);
                ...
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             ...
                                                             size_countersList,
                                                             ptr + 8 + 4 + 1 + 4 + 4 + 4 +
                                                             size_countersList, checksumSize,
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glSelectPerfMonitorCountersAMD\n",
                            err);
#endif
                DEBUG("gles2(%p): glSelectPerfMonitorCountersAMD(%u %d %u %d %p(%u) )\n", stream,
                      var_monitor, var_enable, var_group, var_numCounters,
                      (GLuint *) (inptr_countersList.get()), size_countersList);
                this->glSelectPerfMonitorCountersAMD(var_monitor, var_enable, var_group,
                                                     var_numCounters,
                                                     (GLuint *) (inptr_countersList.get()));
            ...
            case OP_glBeginPerfMonitorAMD: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glBeginPerfMonitorAMD\n",
                            err);
#endif
            ...
            case OP_glEndPerfMonitorAMD: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glEndPerfMonitorAMD\n",
                            err);
#endif
            ...
            case OP_glGetPerfMonitorCounterDataAMD: {
                ...
                uint32_t size_data __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4);
                InputBuffer inptr_data(ptr + 8 + 4 + 4 + 4 + 4, size_data);
                uint32_t size_bytesWritten __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4 + size_data);
                InputBuffer inptr_bytesWritten(ptr + 8 + 4 + 4 + 4 + 4 + size_data + 4,
                                               size_bytesWritten);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             ...
                                                             size_bytesWritten,
                                                             ptr + 8 + 4 + 4 + 4 + 4 + size_data +
                                                             4 + size_bytesWritten, checksumSize,
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetPerfMonitorCounterDataAMD\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetPerfMonitorCounterDataAMD(%u 0x%08x %d %p(%u) %p(%u) )\n",
                      stream, var_monitor, var_pname, var_dataSize, (GLuint *) (inptr_data.get()),
                      size_data, (GLint *) (inptr_bytesWritten.get()), size_bytesWritten);
                this->glGetPerfMonitorCounterDataAMD(var_monitor, var_pname, var_dataSize,
                                                     (GLuint *) (inptr_data.get()),
                                                     (GLint *) (inptr_bytesWritten.get()));
            ...
            case OP_glRenderbufferStorageMultisampleIMG: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glRenderbufferStorageMultisampleIMG\n",
                            err);
#endif
            ...
            case OP_glFramebufferTexture2DMultisampleIMG: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glFramebufferTexture2DMultisampleIMG\n",
                            err);
#endif
            ...
            case OP_glDeleteFencesNV: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDeleteFencesNV\n", err);
#endif
            ...
            case OP_glGenFencesNV: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGenFencesNV\n", err);
#endif
            ...
            case OP_glTestFenceNV: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glTestFenceNV\n", err);
#endif
            ...
            case OP_glGetFenceivNV: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetFenceivNV\n", err);
#endif
            ...
            case OP_glFinishFenceNV: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glFinishFenceNV\n", err);
#endif
            ...
            case OP_glCoverageMaskNV: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glCoverageMaskNV\n", err);
#endif
            ...
            case OP_glCoverageOperationNV: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glCoverageOperationNV\n",
                            err);
#endif
            ...
            case OP_glGetDriverControlsQCOM: {
                ...
                uint32_t size_driverControls __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + size_num + 4);
                InputBuffer inptr_driverControls(ptr + 8 + 4 + size_num + 4 + 4,
                                                 size_driverControls);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + size_num + 4 + 4 +
                                                             size_driverControls,
                                                             ptr + 8 + 4 + size_num + 4 + 4 +
                                                             size_driverControls, checksumSize,
                                                             "gles2_decoder_context_t::decode, OP_glGetDriverControlsQCOM: GL checksumCalculator failure\n");
                }
#ifdef CHECK_GL_ERRORS
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetDriverControlsQCOM\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetDriverControlsQCOM(%p(%u) %d %p(%u) )\n", stream,
                      (GLint *) (inptr_num.get()), size_num, var_size,
                      (GLuint *) (inptr_driverControls.get()), size_driverControls);
                this->glGetDriverControlsQCOM((GLint *) (inptr_num.get()), var_size,
                                              (GLuint *) (inptr_driverControls.get()));
            ...
            case OP_glGetDriverControlStringQCOM: {
                ...
                uint32_t size_driverControlString __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + size_length);
                InputBuffer inptr_driverControlString(ptr + 8 + 4 + 4 + 4 + size_length + 4,
                ...
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             ...
                                                             size_driverControlString,
                                                             ptr + 8 + 4 + 4 + 4 + size_length + 4 +
                                                             size_driverControlString, checksumSize,
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetDriverControlStringQCOM\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetDriverControlStringQCOM(%u %d %p(%u) %p(%u) )\n", stream,
                      var_driverControl, var_bufSize, (GLsizei *) (inptr_length.get()), size_length,
                      (GLchar *) (inptr_driverControlString.get()), size_driverControlString);
                this->glGetDriverControlStringQCOM(var_driverControl, var_bufSize,
                                                   (GLsizei *) (inptr_length.get()),
                                                   (GLchar *) (inptr_driverControlString.get()));
            ...
            case OP_glEnableDriverControlQCOM: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glEnableDriverControlQCOM\n", err);
#endif
            ...
            case OP_glDisableDriverControlQCOM: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glDisableDriverControlQCOM\n",
                            err);
#endif
            ...
            case OP_glExtGetTexturesQCOM: {
                ...
                uint32_t size_numTextures __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + size_textures + 4);
                InputBuffer inptr_numTextures(ptr + 8 + 4 + size_textures + 4 + 4,
                                              size_numTextures);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + size_textures + 4 + 4 +
                                                             size_numTextures,
                                                             ptr + 8 + 4 + size_textures + 4 + 4 +
                                                             size_numTextures, checksumSize,
                                                             "gles2_decoder_context_t::decode, OP_glExtGetTexturesQCOM: GL checksumCalculator failure\n");
                }
#ifdef CHECK_GL_ERRORS
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glExtGetTexturesQCOM\n",
                            err);
#endif
                DEBUG("gles2(%p): glExtGetTexturesQCOM(%p(%u) %d %p(%u) )\n", stream,
                      (GLuint *) (inptr_textures.get()), size_textures, var_maxTextures,
                      (GLint *) (inptr_numTextures.get()), size_numTextures);
                this->glExtGetTexturesQCOM((GLuint *) (inptr_textures.get()), var_maxTextures,
                                           (GLint *) (inptr_numTextures.get()));
            ...
            case OP_glExtGetBuffersQCOM: {
                ...
                uint32_t size_numBuffers __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + size_buffers + 4);
                InputBuffer inptr_numBuffers(ptr + 8 + 4 + size_buffers + 4 + 4, size_numBuffers);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + size_buffers + 4 + 4 +
                                                             size_numBuffers,
                                                             ptr + 8 + 4 + size_buffers + 4 + 4 +
                                                             size_numBuffers, checksumSize,
                                                             "gles2_decoder_context_t::decode, OP_glExtGetBuffersQCOM: GL checksumCalculator failure\n");
                }
#ifdef CHECK_GL_ERRORS
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glExtGetBuffersQCOM\n",
                            err);
#endif
                DEBUG("gles2(%p): glExtGetBuffersQCOM(%p(%u) %d %p(%u) )\n", stream,
                      (GLuint *) (inptr_buffers.get()), size_buffers, var_maxBuffers,
                      (GLint *) (inptr_numBuffers.get()), size_numBuffers);
                this->glExtGetBuffersQCOM((GLuint *) (inptr_buffers.get()), var_maxBuffers,
                                          (GLint *) (inptr_numBuffers.get()));
            ...
            case OP_glExtGetRenderbuffersQCOM: {
                ...
                GLint var_maxRenderbuffers = Unpack<GLint, uint32_t>(
                        ptr + 8 + 4 + size_renderbuffers);
                uint32_t size_numRenderbuffers __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + size_renderbuffers + 4);
                InputBuffer inptr_numRenderbuffers(ptr + 8 + 4 + size_renderbuffers + 4 + 4,
                                                   size_numRenderbuffers);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + size_renderbuffers + 4 + 4 +
                                                             size_numRenderbuffers,
                                                             ptr + 8 + 4 + size_renderbuffers + 4 +
                                                             4 + size_numRenderbuffers,
                                                             checksumSize,
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glExtGetRenderbuffersQCOM\n", err);
#endif
                DEBUG("gles2(%p): glExtGetRenderbuffersQCOM(%p(%u) %d %p(%u) )\n", stream,
                      (GLuint *) (inptr_renderbuffers.get()), size_renderbuffers,
                      var_maxRenderbuffers, (GLint *) (inptr_numRenderbuffers.get()),
                      size_numRenderbuffers);
                this->glExtGetRenderbuffersQCOM((GLuint *) (inptr_renderbuffers.get()),
                                                var_maxRenderbuffers,
                                                (GLint *) (inptr_numRenderbuffers.get()));
            ...
            case OP_glExtGetFramebuffersQCOM: {
                ...
                GLint var_maxFramebuffers = Unpack<GLint, uint32_t>(
                        ptr + 8 + 4 + size_framebuffers);
                uint32_t size_numFramebuffers __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + size_framebuffers + 4);
                InputBuffer inptr_numFramebuffers(ptr + 8 + 4 + size_framebuffers + 4 + 4,
                                                  size_numFramebuffers);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + size_framebuffers + 4 + 4 +
                                                             size_numFramebuffers,
                                                             ptr + 8 + 4 + size_framebuffers + 4 +
                                                             4 + size_numFramebuffers, checksumSize,
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glExtGetFramebuffersQCOM\n", err);
#endif
                DEBUG("gles2(%p): glExtGetFramebuffersQCOM(%p(%u) %d %p(%u) )\n", stream,
                      (GLuint *) (inptr_framebuffers.get()), size_framebuffers, var_maxFramebuffers,
                      (GLint *) (inptr_numFramebuffers.get()), size_numFramebuffers);
                this->glExtGetFramebuffersQCOM((GLuint *) (inptr_framebuffers.get()),
                                               var_maxFramebuffers,
                                               (GLint *) (inptr_numFramebuffers.get()));
            ...
            case OP_glExtGetTexLevelParameterivQCOM: {
                ...
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + 4 + 4 + size_params,
                                                             ptr + 8 + 4 + 4 + 4 + 4 + 4 +
                                                             size_params, checksumSize,
            ...
            case OP_glExtTexObjectStateOverrideiQCOM: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glExtTexObjectStateOverrideiQCOM\n",
                            err);
#endif
            ...
            case OP_glExtGetTexSubImageQCOM: {
                ...
                uint32_t size_texels __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4);
                InputBuffer inptr_texels(ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4,
                                         size_texels);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 +
            ...
            case OP_glExtGetBufferPointervQCOM: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glExtGetBufferPointervQCOM\n",
                            err);
#endif
                DEBUG("gles2(%p): glExtGetBufferPointervQCOM(0x%08x %p(%u) )\n", stream, var_target,
                      (GLvoidptr *) (inptr_params.get()), size_params);
            ...
            case OP_glExtGetShadersQCOM: {
                ...
                uint32_t size_numShaders __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + size_shaders + 4);
                InputBuffer inptr_numShaders(ptr + 8 + 4 + size_shaders + 4 + 4, size_numShaders);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + size_shaders + 4 + 4 +
                                                             size_numShaders,
                                                             ptr + 8 + 4 + size_shaders + 4 + 4 +
                                                             size_numShaders, checksumSize,
                                                             "gles2_decoder_context_t::decode, OP_glExtGetShadersQCOM: GL checksumCalculator failure\n");
                }
#ifdef CHECK_GL_ERRORS
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glExtGetShadersQCOM\n",
                            err);
#endif
                DEBUG("gles2(%p): glExtGetShadersQCOM(%p(%u) %d %p(%u) )\n", stream,
                      (GLuint *) (inptr_shaders.get()), size_shaders, var_maxShaders,
                      (GLint *) (inptr_numShaders.get()), size_numShaders);
                this->glExtGetShadersQCOM((GLuint *) (inptr_shaders.get()), var_maxShaders,
                                          (GLint *) (inptr_numShaders.get()));
            ...
            case OP_glExtGetProgramsQCOM: {
                ...
                uint32_t size_numPrograms __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + size_programs + 4);
                InputBuffer inptr_numPrograms(ptr + 8 + 4 + size_programs + 4 + 4,
                                              size_numPrograms);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + size_programs + 4 + 4 +
                                                             size_numPrograms,
                                                             ptr + 8 + 4 + size_programs + 4 + 4 +
                                                             size_numPrograms, checksumSize,
                                                             "gles2_decoder_context_t::decode, OP_glExtGetProgramsQCOM: GL checksumCalculator failure\n");
                }
#ifdef CHECK_GL_ERRORS
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glExtGetProgramsQCOM\n",
                            err);
#endif
                DEBUG("gles2(%p): glExtGetProgramsQCOM(%p(%u) %d %p(%u) )\n", stream,
                      (GLuint *) (inptr_programs.get()), size_programs, var_maxPrograms,
                      (GLint *) (inptr_numPrograms.get()), size_numPrograms);
                this->glExtGetProgramsQCOM((GLuint *) (inptr_programs.get()), var_maxPrograms,
                                           (GLint *) (inptr_numPrograms.get()));
            ...
            case OP_glExtIsProgramBinaryQCOM: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glExtIsProgramBinaryQCOM\n", err);
#endif
            ...
            case OP_glExtGetProgramBinarySourceQCOM: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glExtGetProgramBinarySourceQCOM\n",
                            err);
#endif
            ...
            case OP_glStartTilingQCOM: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glStartTilingQCOM\n", err);
#endif
            ...
            case OP_glEndTilingQCOM: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glEndTilingQCOM\n", err);
#endif
            ...
            case OP_glVertexAttribPointerData: {
                ...
                GLuint var_datalen = Unpack<GLuint, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 1 + 4 + 4 + size_data);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + 1 + 4 + 4 + size_data +
                                                             4, ptr + 8 + 4 + 4 + 4 + 1 + 4 + 4 +
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glVertexAttribPointerData\n", err);
#endif
                DEBUG("gles2(%p): glVertexAttribPointerData(%u %d 0x%08x %d %d %p(%u) %u )\n",
                      stream, var_indx, var_size, var_type, var_normalized, var_stride,
                      (void *) (inptr_data.get()), size_data, var_datalen);
                this->glVertexAttribPointerData(this, var_indx, var_size, var_type, var_normalized,
                                                var_stride, (void *) (inptr_data.get()),
                                                var_datalen);
            ...
            case OP_glVertexAttribPointerOffset: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glVertexAttribPointerOffset\n",
                            err);
#endif
                DEBUG("gles2(%p): glVertexAttribPointerOffset(%u %d 0x%08x %d %d %u )\n", stream,
                      var_indx, var_size, var_type, var_normalized, var_stride, var_offset);
                this->glVertexAttribPointerOffset(this, var_indx, var_size, var_type,
                                                  var_normalized, var_stride, var_offset);
            ...
            case OP_glDrawElementsOffset: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDrawElementsOffset\n",
                            err);
#endif
            ...
            case OP_glDrawElementsData: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDrawElementsData\n",
                            err);
#endif
            ...
            case OP_glGetCompressedTextureFormats: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetCompressedTextureFormats\n",
                            err);
#endif
            ...
            case OP_glShaderString: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glShaderString\n", err);
#endif
                DEBUG("gles2(%p): glShaderString(%u %p(%u) %d )\n", stream, var_shader,
                      (const GLchar *) (inptr_string.get()), size_string, var_len);
                this->glShaderString(this, var_shader, (const GLchar *) (inptr_string.get()),
                                     var_len);
            ...
            case OP_glFinishRoundTrip: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glFinishRoundTrip\n", err);
#endif
            ...
            case OP_glGenVertexArrays: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGenVertexArrays\n", err);
#endif
            ...
            case OP_glBindVertexArray: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glBindVertexArray\n", err);
#endif
            ...
            case OP_glDeleteVertexArrays: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDeleteVertexArrays\n",
                            err);
#endif
            ...
            case OP_glIsVertexArray: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glIsVertexArray\n", err);
#endif
            ...
            case OP_glMapBufferRange: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glMapBufferRange\n", err);
#endif
                DEBUG("gles2(%p): glMapBufferRange(0x%08x 0x%08lx 0x%08lx 0x%08x )\n", stream,
                      var_target, var_offset, var_length, var_access);
            ...
            case OP_glUnmapBuffer: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glUnmapBuffer\n", err);
#endif
            ...
            case OP_glFlushMappedBufferRange: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glFlushMappedBufferRange\n", err);
#endif
                DEBUG("gles2(%p): glFlushMappedBufferRange(0x%08x 0x%08lx 0x%08lx )\n", stream,
                      var_target, var_offset, var_length);
            ...
            case OP_glMapBufferRangeAEMU: {
                ...
                GLsizeiptr var_length = Unpack<GLsizeiptr, uint32_t>(ptr + 8 + 4 + 4);
                GLbitfield var_access = Unpack<GLbitfield, uint32_t>(ptr + 8 + 4 + 4 + 4);
                uint32_t size_mapped __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + 4 + 4,
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glMapBufferRangeAEMU\n",
                            err);
#endif
                DEBUG("gles2(%p): glMapBufferRangeAEMU(0x%08x 0x%08lx 0x%08lx 0x%08x %p(%u) )\n",
                      stream, var_target, var_offset, var_length, var_access,
                      (void *) (outptr_mapped.get()), size_mapped);
                this->glMapBufferRangeAEMU(this, var_target, var_offset, var_length, var_access,
                                           size_mapped == 0 ? nullptr
                                                            : (void *) (outptr_mapped.get()));
                outptr_mapped.flush();
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
                                                                totalTmpSize - checksumSize,
            ...
            case OP_glUnmapBufferAEMU: {
                ...
                GLsizeiptr var_length = Unpack<GLsizeiptr, uint32_t>(ptr + 8 + 4 + 4);
                GLbitfield var_access = Unpack<GLbitfield, uint32_t>(ptr + 8 + 4 + 4 + 4);
                uint32_t size_guest_buffer __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4);
                InputBuffer inptr_guest_buffer(ptr + 8 + 4 + 4 + 4 + 4 + 4, size_guest_buffer);
                uint32_t size_out_res __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4 + 4 + size_guest_buffer);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + 4 + 4 +
                                                             size_guest_buffer + 4,
                                                             ptr + 8 + 4 + 4 + 4 + 4 + 4 +
                                                             size_guest_buffer + 4, checksumSize,
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glUnmapBufferAEMU\n", err);
#endif
                DEBUG("gles2(%p): glUnmapBufferAEMU(0x%08x 0x%08lx 0x%08lx 0x%08x %p(%u) %p(%u) )\n",
                      stream, var_target, var_offset, var_length, var_access,
                      (void *) (inptr_guest_buffer.get()), size_guest_buffer,
                      (GLboolean *) (outptr_out_res.get()), size_out_res);
                this->glUnmapBufferAEMU(this, var_target, var_offset, var_length, var_access,
                                        size_guest_buffer == 0 ? nullptr
                                                               : (void *) (inptr_guest_buffer.get()),
                                        (GLboolean *) (outptr_out_res.get()));
            ...
            case OP_glFlushMappedBufferRangeAEMU: {
                ...
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             ...
                                                             size_guest_buffer,
                                                             ptr + 8 + 4 + 4 + 4 + 4 + 4 +
                                                             size_guest_buffer, checksumSize,
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glFlushMappedBufferRangeAEMU\n",
                            err);
#endif
                DEBUG("gles2(%p): glFlushMappedBufferRangeAEMU(0x%08x 0x%08lx 0x%08lx 0x%08x %p(%u) )\n",
                      stream, var_target, var_offset, var_length, var_access,
                      (void *) (inptr_guest_buffer.get()), size_guest_buffer);
                this->glFlushMappedBufferRangeAEMU(this, var_target, var_offset, var_length,
                                                   var_access, size_guest_buffer == 0 ? nullptr
                                                                                      : (void *) (inptr_guest_buffer.get()));
            ...
            case OP_glReadPixelsOffsetAEMU: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glReadPixelsOffsetAEMU\n",
                            err);
#endif
                DEBUG("gles2(%p): glReadPixelsOffsetAEMU(%d %d %d %d 0x%08x 0x%08x %u )\n", stream,
                      var_x, var_y, var_width, var_height, var_format, var_type, var_offset);
                this->glReadPixelsOffsetAEMU(this, var_x, var_y, var_width, var_height, var_format,
                                             var_type, var_offset);
            ...
            case OP_glCompressedTexImage2DOffsetAEMU: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glCompressedTexImage2DOffsetAEMU\n",
                            err);
#endif
                DEBUG("gles2(%p): glCompressedTexImage2DOffsetAEMU(0x%08x %d 0x%08x %d %d %d %d %u )\n",
                      stream, var_target, var_level, var_internalformat, var_width, var_height,
                      var_border, var_imageSize, var_offset);
                this->glCompressedTexImage2DOffsetAEMU(this, var_target, var_level,
                                                       var_internalformat, var_width, var_height,
                                                       var_border, var_imageSize, var_offset);
            ...
            case OP_glCompressedTexSubImage2DOffsetAEMU: {
                ...
                GLsizei var_imageSize = Unpack<GLsizei, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4);
                GLuint var_offset = Unpack<GLuint, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4,
            ...
            case OP_glTexImage2DOffsetAEMU: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glTexImage2DOffsetAEMU\n",
                            err);
#endif
                DEBUG("gles2(%p): glTexImage2DOffsetAEMU(0x%08x %d %d %d %d %d 0x%08x 0x%08x %u )\n",
                      stream, var_target, var_level, var_internalformat, var_width, var_height,
                      var_border, var_format, var_type, var_offset);
                this->glTexImage2DOffsetAEMU(this, var_target, var_level, var_internalformat,
                                             var_width, var_height, var_border, var_format,
                                             var_type, var_offset);
            ...
            case OP_glTexSubImage2DOffsetAEMU: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glTexSubImage2DOffsetAEMU\n", err);
#endif
                DEBUG("gles2(%p): glTexSubImage2DOffsetAEMU(0x%08x %d %d %d %d %d 0x%08x 0x%08x %u )\n",
                      stream, var_target, var_level, var_xoffset, var_yoffset, var_width,
                      var_height, var_format, var_type, var_offset);
                this->glTexSubImage2DOffsetAEMU(this, var_target, var_level, var_xoffset,
                                                var_yoffset, var_width, var_height, var_format,
                                                var_type, var_offset);
            ...
            case OP_glBindBufferRange: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glBindBufferRange\n", err);
#endif
                DEBUG("gles2(%p): glBindBufferRange(0x%08x %u %u 0x%08lx 0x%08lx )\n", stream,
                      var_target, var_index, var_buffer, var_offset, var_size);
            ...
            case OP_glBindBufferBase: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glBindBufferBase\n", err);
#endif
                DEBUG("gles2(%p): glBindBufferBase(0x%08x %u %u )\n", stream, var_target, var_index,
                      var_buffer);
            ...
            case OP_glCopyBufferSubData: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glCopyBufferSubData\n",
                            err);
#endif
                DEBUG("gles2(%p): glCopyBufferSubData(0x%08x 0x%08x 0x%08lx 0x%08lx 0x%08lx )\n",
                      stream, var_readtarget, var_writetarget, var_readoffset, var_writeoffset,
                      var_size);
                this->glCopyBufferSubData(var_readtarget, var_writetarget, var_readoffset,
                                          var_writeoffset, var_size);
            ...
            case OP_glClearBufferiv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glClearBufferiv\n", err);
#endif
                DEBUG("gles2(%p): glClearBufferiv(0x%08x %d %p(%u) )\n", stream, var_buffer,
                      var_drawBuffer, (const GLint *) (inptr_value.get()), size_value);
                this->glClearBufferiv(var_buffer, var_drawBuffer,
                                      (const GLint *) (inptr_value.get()));
            ...
            case OP_glClearBufferuiv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glClearBufferuiv\n", err);
#endif
                DEBUG("gles2(%p): glClearBufferuiv(0x%08x %d %p(%u) )\n", stream, var_buffer,
                      var_drawBuffer, (const GLuint *) (inptr_value.get()), size_value);
                this->glClearBufferuiv(var_buffer, var_drawBuffer,
                                       (const GLuint *) (inptr_value.get()));
            ...
            case OP_glClearBufferfv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glClearBufferfv\n", err);
#endif
                DEBUG("gles2(%p): glClearBufferfv(0x%08x %d %p(%u) )\n", stream, var_buffer,
                      var_drawBuffer, (const GLfloat *) (inptr_value.get()), size_value);
                this->glClearBufferfv(var_buffer, var_drawBuffer,
                                      (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glClearBufferfi: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glClearBufferfi\n", err);
#endif
                DEBUG("gles2(%p): glClearBufferfi(0x%08x %d %f %d )\n", stream, var_buffer,
                      var_drawBuffer, var_depth, var_stencil);
            ...
            case OP_glGetBufferParameteri64v: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetBufferParameteri64v\n", err);
#endif
                DEBUG("gles2(%p): glGetBufferParameteri64v(0x%08x 0x%08x %p(%u) )\n", stream,
                      var_target, var_value, (GLint64 *) (inptr_data.get()), size_data);
                this->glGetBufferParameteri64v(var_target, var_value,
                                               (GLint64 *) (inptr_data.get()));
            ...
            case OP_glGetBufferPointerv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetBufferPointerv\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetBufferPointerv(0x%08x 0x%08x %p(%u) )\n", stream, var_target,
                      var_pname, (GLvoid **) (inptr_params.get()), size_params);
            ...
            case OP_glUniformBlockBinding: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glUniformBlockBinding\n",
                            err);
#endif
                DEBUG("gles2(%p): glUniformBlockBinding(%u %u %u )\n", stream, var_program,
                      var_uniformBlockIndex, var_uniformBlockBinding);
                this->glUniformBlockBinding_dec(this, var_program, var_uniformBlockIndex,
                                                var_uniformBlockBinding);
                SET_LASTCALL("glUniformBlockBinding");
                break;
            }
            case OP_glGetUniformBlockIndex: {
                GLuint var_program = Unpack<GLuint, uint32_t>(ptr + 8);
                uint32_t size_uniformBlockName __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4);
                InputBuffer inptr_uniformBlockName(ptr + 8 + 4 + 4, size_uniformBlockName);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + size_uniformBlockName,
                                                             ptr + 8 + 4 + 4 +
                                                             size_uniformBlockName, checksumSize,
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetUniformBlockIndex\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetUniformBlockIndex(%u %p(%u) )\n", stream, var_program,
                      (const GLchar *) (inptr_uniformBlockName.get()), size_uniformBlockName);
                *(GLuint *) (&tmpBuf[0]) = this->glGetUniformBlockIndex_dec(this, var_program,
                                                                            (const GLchar *) (inptr_uniformBlockName.get()));
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
                                                                totalTmpSize - checksumSize,
                                                                &tmpBuf[totalTmpSize -
            ...
            case OP_glGetUniformIndices: {
                ...
                uint32_t size_uniformNames __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4);
                InputBuffer inptr_uniformNames(ptr + 8 + 4 + 4 + 4, size_uniformNames);
                uint32_t size_uniformIndices __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + size_uniformNames);
                InputBuffer inptr_uniformIndices(ptr + 8 + 4 + 4 + 4 + size_uniformNames + 4,
                                                 size_uniformIndices);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + size_uniformNames + 4 +
                                                             size_uniformIndices,
                                                             ptr + 8 + 4 + 4 + 4 +
                                                             size_uniformNames + 4 +
                                                             size_uniformIndices, checksumSize,
                                                             "gles2_decoder_context_t::decode, OP_glGetUniformIndices: GL checksumCalculator failure\n");
                }
#ifdef CHECK_GL_ERRORS
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetUniformIndices\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetUniformIndices(%u %d %p(%u) %p(%u) )\n", stream, var_program,
                      var_uniformCount, (const GLchar **) (inptr_uniformNames.get()),
                      size_uniformNames, (GLuint *) (inptr_uniformIndices.get()),
                      size_uniformIndices);
                this->glGetUniformIndices(var_program, var_uniformCount,
                                          (const GLchar **) (inptr_uniformNames.get()),
                                          (GLuint *) (inptr_uniformIndices.get()));
            ...
            case OP_glGetUniformIndicesAEMU: {
                GLuint var_program = Unpack<GLuint, uint32_t>(ptr + 8);
                GLsizei var_uniformCount = Unpack<GLsizei, uint32_t>(ptr + 8 + 4);
                uint32_t size_packedUniformNames __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4);
                InputBuffer inptr_packedUniformNames(ptr + 8 + 4 + 4 + 4, size_packedUniformNames);
                GLsizei var_packedLen = Unpack<GLsizei, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + size_packedUniformNames);
                uint32_t size_uniformIndices __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + size_packedUniformNames + 4);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr, 8 + 4 + 4 + 4 +
                                                                                size_packedUniformNames +
                                                                                4 + 4,
                                                             ptr + 8 + 4 + 4 + 4 +
                                                             size_packedUniformNames + 4 + 4,
                                                             checksumSize,
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetUniformIndicesAEMU\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetUniformIndicesAEMU(%u %d %p(%u) %d %p(%u) )\n", stream,
                      var_program, var_uniformCount,
                      (const GLchar *) (inptr_packedUniformNames.get()), size_packedUniformNames,
                      var_packedLen, (GLuint *) (outptr_uniformIndices.get()), size_uniformIndices);
                this->glGetUniformIndicesAEMU(this, var_program, var_uniformCount,
                                              (const GLchar *) (inptr_packedUniformNames.get()),
                                              var_packedLen,
                                              (GLuint *) (outptr_uniformIndices.get()));
            ...
            case OP_glGetActiveUniformBlockiv: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetActiveUniformBlockiv\n", err);
#endif
                DEBUG("gles2(%p): glGetActiveUniformBlockiv(%u %u 0x%08x %p(%u) )\n", stream,
                      var_program, var_uniformBlockIndex, var_pname,
                      (GLint *) (outptr_params.get()), size_params);
                this->glGetActiveUniformBlockiv_dec(this, var_program, var_uniformBlockIndex,
                                                    var_pname, (GLint *) (outptr_params.get()));
                outptr_params.flush();
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
                                                                totalTmpSize - checksumSize,
            ...
            case OP_glGetActiveUniformBlockName: {
                ...
                unsigned char *tmpBuf = stream->alloc(totalTmpSize);
                OutputBuffer outptr_length(&tmpBuf[0], size_length);
                OutputBuffer outptr_uniformBlockName(&tmpBuf[0 + size_length],
                                                     size_uniformBlockName);
#ifdef CHECK_GL_ERRORS
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetActiveUniformBlockName\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetActiveUniformBlockName(%u %u %d %p(%u) %p(%u) )\n", stream,
                      var_program, var_uniformBlockIndex, var_bufSize,
                      (GLsizei *) (outptr_length.get()), size_length,
                      (GLchar *) (outptr_uniformBlockName.get()), size_uniformBlockName);
                this->glGetActiveUniformBlockName_dec(this, var_program, var_uniformBlockIndex,
                                                      var_bufSize, size_length == 0 ? nullptr
                                                                                    : (GLsizei *) (outptr_length.get()),
                                                      size_uniformBlockName == 0 ? nullptr
                                                                                 : (GLchar *) (outptr_uniformBlockName.get()));
                outptr_length.flush();
            ...
            case OP_glUniform1uiv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glUniform1uiv\n", err);
#endif
                DEBUG("gles2(%p): glUniform1uiv(%d %d %p(%u) )\n", stream, var_location, var_count,
                      (const GLuint *) (inptr_value.get()), size_value);
            ...
            case OP_glUniform2uiv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glUniform2uiv\n", err);
#endif
            ...
            case OP_glUniform3uiv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glUniform3uiv\n", err);
#endif
            ...
            case OP_glUniform4uiv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glUniform4uiv\n", err);
#endif
            ...
            case OP_glUniformMatrix2x3fv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glUniformMatrix2x3fv\n",
                            err);
#endif
                DEBUG("gles2(%p): glUniformMatrix2x3fv(%d %d %d %p(%u) )\n", stream, var_location,
                      var_count, var_transpose, (const GLfloat *) (inptr_value.get()), size_value);
                this->glUniformMatrix2x3fv(var_location, var_count, var_transpose,
                                           (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glUniformMatrix3x2fv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glUniformMatrix3x2fv\n",
                            err);
#endif
                DEBUG("gles2(%p): glUniformMatrix3x2fv(%d %d %d %p(%u) )\n", stream, var_location,
                      var_count, var_transpose, (const GLfloat *) (inptr_value.get()), size_value);
                this->glUniformMatrix3x2fv(var_location, var_count, var_transpose,
                                           (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glUniformMatrix2x4fv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glUniformMatrix2x4fv\n",
                            err);
#endif
                DEBUG("gles2(%p): glUniformMatrix2x4fv(%d %d %d %p(%u) )\n", stream, var_location,
                      var_count, var_transpose, (const GLfloat *) (inptr_value.get()), size_value);
                this->glUniformMatrix2x4fv(var_location, var_count, var_transpose,
                                           (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glUniformMatrix4x2fv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glUniformMatrix4x2fv\n",
                            err);
#endif
                DEBUG("gles2(%p): glUniformMatrix4x2fv(%d %d %d %p(%u) )\n", stream, var_location,
                      var_count, var_transpose, (const GLfloat *) (inptr_value.get()), size_value);
                this->glUniformMatrix4x2fv(var_location, var_count, var_transpose,
                                           (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glUniformMatrix3x4fv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glUniformMatrix3x4fv\n",
                            err);
#endif
                DEBUG("gles2(%p): glUniformMatrix3x4fv(%d %d %d %p(%u) )\n", stream, var_location,
                      var_count, var_transpose, (const GLfloat *) (inptr_value.get()), size_value);
                this->glUniformMatrix3x4fv(var_location, var_count, var_transpose,
                                           (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glUniformMatrix4x3fv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glUniformMatrix4x3fv\n",
                            err);
#endif
                DEBUG("gles2(%p): glUniformMatrix4x3fv(%d %d %d %p(%u) )\n", stream, var_location,
                      var_count, var_transpose, (const GLfloat *) (inptr_value.get()), size_value);
                this->glUniformMatrix4x3fv(var_location, var_count, var_transpose,
                                           (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glGetUniformuiv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetUniformuiv\n", err);
#endif
                DEBUG("gles2(%p): glGetUniformuiv(%u %d %p(%u) )\n", stream, var_program,
                      var_location, (GLuint *) (outptr_params.get()), size_params);
                this->glGetUniformuiv_dec(this, var_program, var_location,
                                          (GLuint *) (outptr_params.get()));
                outptr_params.flush();
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
                                                                totalTmpSize - checksumSize,
            ...
            case OP_glGetActiveUniformsiv: {
                ...
                GLenum var_pname = Unpack<GLenum, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + size_uniformIndices);
                uint32_t size_params __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + size_uniformIndices + 4);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + size_uniformIndices +
                                                             4 + 4, ptr + 8 + 4 + 4 + 4 +
                                                                    size_uniformIndices + 4 + 4,
                                                             checksumSize,
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetActiveUniformsiv\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetActiveUniformsiv(%u %d %p(%u) 0x%08x %p(%u) )\n", stream,
                      var_program, var_uniformCount, (const GLuint *) (inptr_uniformIndices.get()),
                      size_uniformIndices, var_pname, (GLint *) (outptr_params.get()), size_params);
                this->glGetActiveUniformsiv_dec(this, var_program, var_uniformCount,
                                                (const GLuint *) (inptr_uniformIndices.get()),
                                                var_pname, (GLint *) (outptr_params.get()));
                outptr_params.flush();
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
            ...
            case OP_glVertexAttribI4i: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glVertexAttribI4i\n", err);
#endif
                DEBUG("gles2(%p): glVertexAttribI4i(%u %d %d %d %d )\n", stream, var_index, var_v0,
                      var_v1, var_v2, var_v3);
            ...
            case OP_glVertexAttribI4ui: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glVertexAttribI4ui\n",
                            err);
#endif
            ...
            case OP_glVertexAttribI4iv: {
                ...
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr, 8 + 4 + 4 + size_v,
                                                             ptr + 8 + 4 + 4 + size_v, checksumSize,
                                                             "gles2_decoder_context_t::decode, OP_glVertexAttribI4iv: GL checksumCalculator failure\n");
                }
#ifdef CHECK_GL_ERRORS
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glVertexAttribI4iv\n",
                            err);
#endif
            ...
            case OP_glVertexAttribI4uiv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glVertexAttribI4uiv\n",
                            err);
#endif
                DEBUG("gles2(%p): glVertexAttribI4uiv(%u %p(%u) )\n", stream, var_index,
                      (const GLuint *) (inptr_v.get()), size_v);
            ...
            case OP_glVertexAttribIPointer: {
                ...
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + 4 + 4 + size_pointer,
                                                             ptr + 8 + 4 + 4 + 4 + 4 + 4 +
                                                             size_pointer, checksumSize,
                                                             "gles2_decoder_context_t::decode, OP_glVertexAttribIPointer: GL checksumCalculator failure\n");
                }
#ifdef CHECK_GL_ERRORS
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glVertexAttribIPointer\n",
                            err);
#endif
                DEBUG("gles2(%p): glVertexAttribIPointer(%u %d 0x%08x %d %p(%u) )\n", stream,
                      var_index, var_size, var_type, var_stride,
                      (const GLvoid *) (inptr_pointer.get()), size_pointer);
                this->glVertexAttribIPointer(var_index, var_size, var_type, var_stride,
            ...
            case OP_glVertexAttribIPointerOffsetAEMU: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glVertexAttribIPointerOffsetAEMU\n",
                            err);
#endif
                DEBUG("gles2(%p): glVertexAttribIPointerOffsetAEMU(%u %d 0x%08x %d %u )\n", stream,
                      var_index, var_size, var_type, var_stride, var_offset);
                this->glVertexAttribIPointerOffsetAEMU(this, var_index, var_size, var_type,
            ...
            case OP_glVertexAttribIPointerDataAEMU: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glVertexAttribIPointerDataAEMU\n",
                            err);
#endif
                DEBUG("gles2(%p): glVertexAttribIPointerDataAEMU(%u %d 0x%08x %d %p(%u) %u )\n",
                      stream, var_index, var_size, var_type, var_stride,
                      (void *) (inptr_data.get()), size_data, var_datalen);
                this->glVertexAttribIPointerDataAEMU(this, var_index, var_size, var_type,
                                                     var_stride, (void *) (inptr_data.get()),
                                                     var_datalen);
            ...
            case OP_glGetVertexAttribIiv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetVertexAttribIiv\n",
                            err);
#endif
            ...
            case OP_glGetVertexAttribIuiv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetVertexAttribIuiv\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetVertexAttribIuiv(%u 0x%08x %p(%u) )\n", stream, var_index,
                      var_pname, (GLuint *) (outptr_params.get()), size_params);
            ...
            case OP_glVertexAttribDivisor: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glVertexAttribDivisor\n",
                            err);
#endif
            ...
            case OP_glDrawArraysInstanced: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDrawArraysInstanced\n",
                            err);
#endif
                DEBUG("gles2(%p): glDrawArraysInstanced(0x%08x %d %d %d )\n", stream, var_mode,
                      var_first, var_count, var_primcount);
            ...
            case OP_glDrawElementsInstanced: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDrawElementsInstanced\n",
                            err);
#endif
                DEBUG("gles2(%p): glDrawElementsInstanced(0x%08x %d 0x%08x %p(%u) %d )\n", stream,
                      var_mode, var_count, var_type, (const void *) (inptr_indices.get()),
                      size_indices, var_primcount);
                this->glDrawElementsInstanced(var_mode, var_count, var_type,
                                              (const void *) (inptr_indices.get()), var_primcount);
            ...
            case OP_glDrawElementsInstancedDataAEMU: {
                ...
                GLsizei var_primcount = Unpack<GLsizei, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4 + size_indices);
                GLsizei var_datalen = Unpack<GLsizei, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4 + size_indices + 4);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + 4 + size_indices + 4 +
                                                             4, ptr + 8 + 4 + 4 + 4 + 4 +
                                                                size_indices + 4 + 4, checksumSize,
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glDrawElementsInstancedDataAEMU\n",
                            err);
#endif
                DEBUG("gles2(%p): glDrawElementsInstancedDataAEMU(0x%08x %d 0x%08x %p(%u) %d %d )\n",
                      stream, var_mode, var_count, var_type, (const void *) (inptr_indices.get()),
                      size_indices, var_primcount, var_datalen);
                this->glDrawElementsInstancedDataAEMU(this, var_mode, var_count, var_type,
                                                      (const void *) (inptr_indices.get()),
                                                      var_primcount, var_datalen);
            ...
            case OP_glDrawElementsInstancedOffsetAEMU: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glDrawElementsInstancedOffsetAEMU\n",
                            err);
#endif
            ...
            case OP_glDrawRangeElements: {
                ...
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             ...
                                                             size_indices,
                                                             ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 +
                                                             size_indices, checksumSize,
                                                             "gles2_decoder_context_t::decode, OP_glDrawRangeElements: GL checksumCalculator failure\n");
                }
#ifdef CHECK_GL_ERRORS
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDrawRangeElements\n",
                            err);
#endif
                DEBUG("gles2(%p): glDrawRangeElements(0x%08x %u %u %d 0x%08x %p(%u) )\n", stream,
                      var_mode, var_start, var_end, var_count, var_type,
                      (const GLvoid *) (inptr_indices.get()), size_indices);
            ...
            case OP_glDrawRangeElementsDataAEMU: {
                ...
                InputBuffer inptr_indices(ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4, size_indices);
                GLsizei var_datalen = Unpack<GLsizei, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + size_indices);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + 4 + 4 + 4 +
                                                             size_indices + 4,
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glDrawRangeElementsDataAEMU\n",
                            err);
#endif
                DEBUG("gles2(%p): glDrawRangeElementsDataAEMU(0x%08x %u %u %d 0x%08x %p(%u) %d )\n",
                      stream, var_mode, var_start, var_end, var_count, var_type,
                      (const GLvoid *) (inptr_indices.get()), size_indices, var_datalen);
                this->glDrawRangeElementsDataAEMU(this, var_mode, var_start, var_end, var_count,
            ...
            case OP_glDrawRangeElementsOffsetAEMU: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glDrawRangeElementsOffsetAEMU\n",
                            err);
#endif
                ...
                this->glDrawRangeElementsOffsetAEMU(this, var_mode, var_start, var_end, var_count,
                                                    var_type, var_offset);
            ...
            case OP_glClientWaitSync: {
                ...
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr, 8 + 8 + 4 + 8,
                                                             ptr + 8 + 8 + 4 + 8, checksumSize,
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glClientWaitSync\n", err);
#endif
                DEBUG("gles2(%p): glClientWaitSync(%p 0x%08x 0x%016lx )\n", stream, var_wait_on,
                      var_flags, var_timeout);
                *(GLenum *) (&tmpBuf[0]) = this->glClientWaitSync(var_wait_on, var_flags,
                                                                  var_timeout);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
                                                                totalTmpSize - checksumSize,
            ...
            case OP_glDeleteSync: {
                ...
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr, 8 + 8, ptr + 8 + 8,
                                                             checksumSize,
            ...
            case OP_glGetSynciv: {
                ...
                uint32_t size_values __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 8 + 4 + 4 + 4 + size_length);
                InputBuffer inptr_values(ptr + 8 + 8 + 4 + 4 + 4 + size_length + 4, size_values);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 8 + 4 + 4 + 4 + size_length + 4 +
                                                             size_values,
                                                             ptr + 8 + 8 + 4 + 4 + 4 + size_length +
                                                             4 + size_values, checksumSize,
                ...
                DEBUG("gles2(%p): glGetSynciv(%p 0x%08x %d %p(%u) %p(%u) )\n", stream, var_sync,
                      var_pname, var_bufSize, (GLsizei *) (inptr_length.get()), size_length,
                      (GLint *) (inptr_values.get()), size_values);
                this->glGetSynciv(var_sync, var_pname, var_bufSize,
                                  (GLsizei *) (inptr_length.get()), (GLint *) (inptr_values.get()));
            ...
            case OP_glFenceSyncAEMU: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glFenceSyncAEMU\n", err);
#endif
                DEBUG("gles2(%p): glFenceSyncAEMU(0x%08x 0x%08x )\n", stream, var_condition,
                      var_flags);
            ...
            case OP_glClientWaitSyncAEMU: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glClientWaitSyncAEMU\n",
                            err);
#endif
                DEBUG("gles2(%p): glClientWaitSyncAEMU(0x%016lx 0x%08x 0x%016lx )\n", stream,
                      var_wait_on, var_flags, var_timeout);
                *(GLenum *) (&tmpBuf[0]) = this->glClientWaitSyncAEMU(this, var_wait_on, var_flags,
                                                                      var_timeout);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
                                                                totalTmpSize - checksumSize,
            ...
            case OP_glWaitSyncAEMU: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glWaitSyncAEMU\n", err);
#endif
            ...
            case OP_glDeleteSyncAEMU: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDeleteSyncAEMU\n", err);
#endif
            ...
            case OP_glGetSyncivAEMU: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetSyncivAEMU\n", err);
#endif
                DEBUG("gles2(%p): glGetSyncivAEMU(0x%016lx 0x%08x %d %p(%u) %p(%u) )\n", stream,
                      var_sync, var_pname, var_bufSize, (GLsizei *) (outptr_length.get()),
                      size_length, (GLint *) (outptr_values.get()), size_values);
                this->glGetSyncivAEMU(this, var_sync, var_pname, var_bufSize,
                                      size_length == 0 ? nullptr
                                                       : (GLsizei *) (outptr_length.get()),
                                      (GLint *) (outptr_values.get()));
                outptr_length.flush();
                outptr_values.flush();
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
            ...
            case OP_glDrawBuffers: {
                GLsizei var_n = Unpack<GLsizei, uint32_t>(ptr + 8);
                uint32_t size_bufs __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4);
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDrawBuffers\n", err);
#endif
                DEBUG("gles2(%p): glDrawBuffers(%d %p(%u) )\n", stream, var_n,
                      (const GLenum *) (inptr_bufs.get()), size_bufs);
            ...
            case OP_glBlitFramebuffer: {
                ...
                GLbitfield var_mask = Unpack<GLbitfield, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4);
                GLenum var_filter = Unpack<GLenum, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 +
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glBlitFramebuffer\n", err);
#endif
                DEBUG("gles2(%p): glBlitFramebuffer(%d %d %d %d %d %d %d %d 0x%08x 0x%08x )\n",
                      stream, var_srcX0, var_srcY0, var_srcX1, var_srcY1, var_dstX0, var_dstY0,
                      var_dstX1, var_dstY1, var_mask, var_filter);
                this->glBlitFramebuffer(var_srcX0, var_srcY0, var_srcX1, var_srcY1, var_dstX0,
                                        var_dstY0, var_dstX1, var_dstY1, var_mask, var_filter);
            ...
            case OP_glInvalidateFramebuffer: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glInvalidateFramebuffer\n",
                            err);
#endif
                DEBUG("gles2(%p): glInvalidateFramebuffer(0x%08x %d %p(%u) )\n", stream, var_target,
                      var_numAttachments, (const GLenum *) (inptr_attachments.get()),
                      size_attachments);
                this->glInvalidateFramebuffer(var_target, var_numAttachments,
                                              (const GLenum *) (inptr_attachments.get()));
            ...
            case OP_glInvalidateSubFramebuffer: {
                ...
                GLsizei var_width = Unpack<GLsizei, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + size_attachments + 4 + 4);
                GLsizei var_height = Unpack<GLsizei, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + size_attachments + 4 + 4 + 4);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + size_attachments + 4 +
                                                             4 + 4 + 4, ptr + 8 + 4 + 4 + 4 +
                                                                        size_attachments + 4 + 4 +
                                                                        4 + 4, checksumSize,
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glInvalidateSubFramebuffer\n",
                            err);
#endif
                DEBUG("gles2(%p): glInvalidateSubFramebuffer(0x%08x %d %p(%u) %d %d %d %d )\n",
                      stream, var_target, var_numAttachments,
                      (const GLenum *) (inptr_attachments.get()), size_attachments, var_x, var_y,
                      var_width, var_height);
                this->glInvalidateSubFramebuffer(var_target, var_numAttachments,
                                                 (const GLenum *) (inptr_attachments.get()), var_x,
                                                 var_y, var_width, var_height);
            ...
            case OP_glFramebufferTextureLayer: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glFramebufferTextureLayer\n", err);
#endif
                DEBUG("gles2(%p): glFramebufferTextureLayer(0x%08x 0x%08x %u %d %d )\n", stream,
                      var_target, var_attachment, var_texture, var_level, var_layer);
                this->glFramebufferTextureLayer(var_target, var_attachment, var_texture, var_level,
                                                var_layer);
            ...
            case OP_glRenderbufferStorageMultisample: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glRenderbufferStorageMultisample\n",
                            err);
#endif
                DEBUG("gles2(%p): glRenderbufferStorageMultisample(0x%08x %d 0x%08x %d %d )\n",
                      stream, var_target, var_samples, var_internalformat, var_width, var_height);
                this->glRenderbufferStorageMultisample(var_target, var_samples, var_internalformat,
                                                       var_width, var_height);
            ...
            case OP_glTexStorage2D: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glTexStorage2D\n", err);
#endif
                DEBUG("gles2(%p): glTexStorage2D(0x%08x %d 0x%08x %d %d )\n", stream, var_target,
                      var_levels, var_internalformat, var_width, var_height);
                this->glTexStorage2D(var_target, var_levels, var_internalformat, var_width,
                                     var_height);
            ...
            case OP_glGetInternalformativ: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetInternalformativ\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetInternalformativ(0x%08x 0x%08x 0x%08x %d %p(%u) )\n", stream,
                      var_target, var_internalformat, var_pname, var_bufSize,
                      (GLint *) (outptr_params.get()), size_params);
                this->glGetInternalformativ(var_target, var_internalformat, var_pname, var_bufSize,
                                            (GLint *) (outptr_params.get()));
                outptr_params.flush();
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
            ...
            case OP_glBeginTransformFeedback: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glBeginTransformFeedback\n", err);
#endif
            ...
            case OP_glEndTransformFeedback: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glEndTransformFeedback\n",
                            err);
#endif
            ...
            case OP_glGenTransformFeedbacks: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGenTransformFeedbacks\n",
                            err);
#endif
                DEBUG("gles2(%p): glGenTransformFeedbacks(%d %p(%u) )\n", stream, var_n,
                      (GLuint *) (outptr_ids.get()), size_ids);
            ...
            case OP_glDeleteTransformFeedbacks: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glDeleteTransformFeedbacks\n",
                            err);
#endif
                DEBUG("gles2(%p): glDeleteTransformFeedbacks(%d %p(%u) )\n", stream, var_n,
                      (const GLuint *) (inptr_ids.get()), size_ids);
                this->glDeleteTransformFeedbacks_dec(this, var_n,
                                                     (const GLuint *) (inptr_ids.get()));
            ...
            case OP_glBindTransformFeedback: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glBindTransformFeedback\n",
                            err);
#endif
            ...
            case OP_glPauseTransformFeedback: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glPauseTransformFeedback\n", err);
#endif
            ...
            case OP_glResumeTransformFeedback: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glResumeTransformFeedback\n", err);
#endif
            ...
            case OP_glIsTransformFeedback: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glIsTransformFeedback\n",
                            err);
#endif
            ...
            case OP_glTransformFeedbackVaryings: {
                GLuint var_program = Unpack<GLuint, uint32_t>(ptr + 8);
                GLsizei var_count = Unpack<GLsizei, uint32_t>(ptr + 8 + 4);
                uint32_t size_varyings __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4);
                InputBuffer inptr_varyings(ptr + 8 + 4 + 4 + 4, size_varyings);
                GLenum var_bufferMode = Unpack<GLenum, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + size_varyings);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + size_varyings + 4,
                                                             ptr + 8 + 4 + 4 + 4 + size_varyings +
                                                             4, checksumSize,
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glTransformFeedbackVaryings\n",
                            err);
#endif
                DEBUG("gles2(%p): glTransformFeedbackVaryings(%u %d %p(%u) 0x%08x )\n", stream,
                      var_program, var_count, (const char **) (inptr_varyings.get()), size_varyings,
                      var_bufferMode);
                this->glTransformFeedbackVaryings_dec(this, var_program, var_count,
                                                      (const char **) (inptr_varyings.get()),
                                                      var_bufferMode);
            ...
            case OP_glTransformFeedbackVaryingsAEMU: {
                GLuint var_program = Unpack<GLuint, uint32_t>(ptr + 8);
                GLsizei var_count = Unpack<GLsizei, uint32_t>(ptr + 8 + 4);
                uint32_t size_packedVaryings __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4);
                InputBuffer inptr_packedVaryings(ptr + 8 + 4 + 4 + 4, size_packedVaryings);
                GLuint var_packedVaryingsLen = Unpack<GLuint, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + size_packedVaryings);
                GLenum var_bufferMode = Unpack<GLenum, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + size_packedVaryings + 4);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + size_packedVaryings +
                                                             4 + 4, ptr + 8 + 4 + 4 + 4 +
                                                                    size_packedVaryings + 4 + 4,
                                                             checksumSize,
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glTransformFeedbackVaryingsAEMU\n",
                            err);
#endif
                DEBUG("gles2(%p): glTransformFeedbackVaryingsAEMU(%u %d %p(%u) %u 0x%08x )\n",
                      stream, var_program, var_count, (const char *) (inptr_packedVaryings.get()),
                      size_packedVaryings, var_packedVaryingsLen, var_bufferMode);
                this->glTransformFeedbackVaryingsAEMU(this, var_program, var_count,
                                                      (const char *) (inptr_packedVaryings.get()),
                                                      var_packedVaryingsLen, var_bufferMode);
            ...
            case OP_glGetTransformFeedbackVarying: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetTransformFeedbackVarying\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetTransformFeedbackVarying(%u %u %d %p(%u) %p(%u) %p(%u) %p(%u) )\n",
                      stream, var_program, var_index, var_bufSize,
                      (GLsizei *) (outptr_length.get()), size_length,
                      (GLsizei *) (outptr_size.get()), size_size, (GLenum *) (outptr_type.get()),
                      size_type, (char *) (outptr_name.get()), size_name);
                this->glGetTransformFeedbackVarying_dec(this, var_program, var_index, var_bufSize,
                                                        size_length == 0 ? nullptr
                                                                         : (GLsizei *) (outptr_length.get()),
                                                        (GLsizei *) (outptr_size.get()),
                                                        size_type == 0 ? nullptr
                                                                       : (GLenum *) (outptr_type.get()),
                                                        size_name == 0 ? nullptr
                                                                       : (char *) (outptr_name.get()));
                outptr_length.flush();
                outptr_size.flush();
                outptr_type.flush();
                outptr_name.flush();
            ...
            case OP_glGenSamplers: {
                GLsizei var_n = Unpack<GLsizei, uint32_t>(ptr + 8);
                uint32_t size_samplers __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr, 8 + 4 + 4,
                                                             ptr + 8 + 4 + 4, checksumSize,
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGenSamplers\n", err);
#endif
                DEBUG("gles2(%p): glGenSamplers(%d %p(%u) )\n", stream, var_n,
                      (GLuint *) (outptr_samplers.get()), size_samplers);
            ...
            case OP_glDeleteSamplers: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDeleteSamplers\n", err);
#endif
                DEBUG("gles2(%p): glDeleteSamplers(%d %p(%u) )\n", stream, var_n,
                      (const GLuint *) (inptr_samplers.get()), size_samplers);
            ...
            case OP_glBindSampler: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glBindSampler\n", err);
#endif
            ...
            case OP_glSamplerParameterf: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glSamplerParameterf\n",
                            err);
#endif
            ...
            case OP_glSamplerParameteri: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glSamplerParameteri\n",
                            err);
#endif
            ...
            case OP_glSamplerParameterfv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glSamplerParameterfv\n",
                            err);
#endif
                DEBUG("gles2(%p): glSamplerParameterfv(%u 0x%08x %p(%u) )\n", stream, var_sampler,
                      var_pname, (const GLfloat *) (inptr_params.get()), size_params);
                this->glSamplerParameterfv(var_sampler, var_pname,
                                           (const GLfloat *) (inptr_params.get()));
            ...
            case OP_glSamplerParameteriv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glSamplerParameteriv\n",
                            err);
#endif
                DEBUG("gles2(%p): glSamplerParameteriv(%u 0x%08x %p(%u) )\n", stream, var_sampler,
                      var_pname, (const GLint *) (inptr_params.get()), size_params);
                this->glSamplerParameteriv(var_sampler, var_pname,
                                           (const GLint *) (inptr_params.get()));
            ...
            case OP_glGetSamplerParameterfv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetSamplerParameterfv\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetSamplerParameterfv(%u 0x%08x %p(%u) )\n", stream,
                      var_sampler, var_pname, (GLfloat *) (outptr_params.get()), size_params);
                this->glGetSamplerParameterfv(var_sampler, var_pname,
                                              (GLfloat *) (outptr_params.get()));
                outptr_params.flush();
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
            ...
            case OP_glGetSamplerParameteriv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetSamplerParameteriv\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetSamplerParameteriv(%u 0x%08x %p(%u) )\n", stream,
                      var_sampler, var_pname, (GLint *) (outptr_params.get()), size_params);
                this->glGetSamplerParameteriv(var_sampler, var_pname,
                                              (GLint *) (outptr_params.get()));
                outptr_params.flush();
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
            ...
            case OP_glGenQueries: {
                GLsizei var_n = Unpack<GLsizei, uint32_t>(ptr + 8);
                uint32_t size_queries __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr, 8 + 4 + 4,
                                                             ptr + 8 + 4 + 4, checksumSize,
                ...
                DEBUG("gles2(%p): glGenQueries(%d %p(%u) )\n", stream, var_n,
                      (GLuint *) (outptr_queries.get()), size_queries);
            ...
            case OP_glDeleteQueries: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDeleteQueries\n", err);
#endif
                DEBUG("gles2(%p): glDeleteQueries(%d %p(%u) )\n", stream, var_n,
                      (const GLuint *) (inptr_queries.get()), size_queries);
            ...
            case OP_glGetQueryObjectuiv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetQueryObjectuiv\n",
                            err);
#endif
            ...
            case OP_glProgramParameteri: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramParameteri\n",
                            err);
#endif
            ...
            case OP_glProgramBinary: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramBinary\n", err);
#endif
                DEBUG("gles2(%p): glProgramBinary(%u 0x%08x %p(%u) %d )\n", stream, var_program,
                      var_binaryFormat, (const void *) (inptr_binary.get()), size_binary,
                      var_length);
                this->glProgramBinary_dec(this, var_program, var_binaryFormat,
                                          (const void *) (inptr_binary.get()), var_length);
            ...
            case OP_glGetProgramBinary: {
                ...
                OutputBuffer outptr_binary(&tmpBuf[0 + size_length + size_binaryFormat],
                                           size_binary);
#ifdef CHECK_GL_ERRORS
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetProgramBinary\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetProgramBinary(%u %d %p(%u) %p(%u) %p(%u) )\n", stream,
                      var_program, var_bufSize, (GLsizei *) (outptr_length.get()), size_length,
                      (GLenum *) (outptr_binaryFormat.get()), size_binaryFormat,
                      (void *) (outptr_binary.get()), size_binary);
                this->glGetProgramBinary_dec(this, var_program, var_bufSize,
                                             size_length == 0 ? nullptr
                                                              : (GLsizei *) (outptr_length.get()),
                                             (GLenum *) (outptr_binaryFormat.get()),
                                             (void *) (outptr_binary.get()));
                outptr_length.flush();
            ...
            case OP_glGetFragDataLocation: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetFragDataLocation\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetFragDataLocation(%u %p(%u) )\n", stream, var_program,
                      (const char *) (inptr_name.get()), size_name);
                *(GLint *) (&tmpBuf[0]) = this->glGetFragDataLocation_dec(this, var_program,
                                                                          (const char *) (inptr_name.get()));
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
                                                                totalTmpSize - checksumSize,
                                                                &tmpBuf[totalTmpSize -
            ...
            case OP_glGetInteger64v: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetInteger64v\n", err);
#endif
                DEBUG("gles2(%p): glGetInteger64v(0x%08x %p(%u) )\n", stream, var_pname,
                      (GLint64 *) (outptr_data.get()), size_data);
            ...
            case OP_glGetIntegeri_v: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetIntegeri_v\n", err);
#endif
                DEBUG("gles2(%p): glGetIntegeri_v(0x%08x %u %p(%u) )\n", stream, var_target,
                      var_index, (GLint *) (outptr_data.get()), size_data);
            ...
            case OP_glGetInteger64i_v: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetInteger64i_v\n", err);
#endif
                DEBUG("gles2(%p): glGetInteger64i_v(0x%08x %u %p(%u) )\n", stream, var_target,
                      var_index, (GLint64 *) (outptr_data.get()), size_data);
            ...
            case OP_glTexImage3DOffsetAEMU: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glTexImage3DOffsetAEMU\n",
                            err);
#endif
                DEBUG("gles2(%p): glTexImage3DOffsetAEMU(0x%08x %d %d %d %d %d %d 0x%08x 0x%08x %u )\n",
                      stream, var_target, var_level, var_internalFormat, var_width, var_height,
                      var_depth, var_border, var_format, var_type, var_offset);
                this->glTexImage3DOffsetAEMU(this, var_target, var_level, var_internalFormat,
                                             var_width, var_height, var_depth, var_border,
                                             var_format, var_type, var_offset);
            ...
            case OP_glTexStorage3D: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glTexStorage3D\n", err);
#endif
                DEBUG("gles2(%p): glTexStorage3D(0x%08x %d 0x%08x %d %d %d )\n", stream, var_target,
                      var_levels, var_internalformat, var_width, var_height, var_depth);
                this->glTexStorage3D(var_target, var_levels, var_internalformat, var_width,
                                     var_height, var_depth);
            ...
            case OP_glTexSubImage3D: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glTexSubImage3D\n", err);
#endif
                DEBUG("gles2(%p): glTexSubImage3D(0x%08x %d %d %d %d %d %d %d 0x%08x 0x%08x %p(%u) )\n",
                      stream, var_target, var_level, var_xoffset, var_yoffset, var_zoffset,
                      var_width, var_height, var_depth, var_format, var_type,
                      (const GLvoid *) (inptr_data.get()), size_data);
                this->glTexSubImage3D(var_target, var_level, var_xoffset, var_yoffset, var_zoffset,
                                      var_width, var_height, var_depth, var_format, var_type,
                                      size_data == 0 ? nullptr
                                                     : (const GLvoid *) (inptr_data.get()));
            ...
            case OP_glTexSubImage3DOffsetAEMU: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glTexSubImage3DOffsetAEMU\n", err);
#endif
                DEBUG("gles2(%p): glTexSubImage3DOffsetAEMU(0x%08x %d %d %d %d %d %d %d 0x%08x 0x%08x %u )\n",
                      stream, var_target, var_level, var_xoffset, var_yoffset, var_zoffset,
                      var_width, var_height, var_depth, var_format, var_type, var_offset);
                this->glTexSubImage3DOffsetAEMU(this, var_target, var_level, var_xoffset,
                                                var_yoffset, var_zoffset, var_width, var_height,
                                                var_depth, var_format, var_type, var_offset);
            ...
            case OP_glCompressedTexImage3D: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glCompressedTexImage3D\n",
                            err);
#endif
                DEBUG("gles2(%p): glCompressedTexImage3D(0x%08x %d 0x%08x %d %d %d %d %d %p(%u) )\n",
                      ...
                      var_depth, var_border, var_imageSize, (const GLvoid *) (inptr_data.get()),
                      size_data);
                this->glCompressedTexImage3D(var_target, var_level, var_internalformat, var_width,
                                             var_height, var_depth, var_border, var_imageSize,
                                             size_data == 0 ? nullptr
                                                            : (const GLvoid *) (inptr_data.get()));
            ...
            case OP_glCompressedTexImage3DOffsetAEMU: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glCompressedTexImage3DOffsetAEMU\n",
                            err);
#endif
                DEBUG("gles2(%p): glCompressedTexImage3DOffsetAEMU(0x%08x %d 0x%08x %d %d %d %d %d %u )\n",
                      stream, var_target, var_level, var_internalformat, var_width, var_height,
                      var_depth, var_border, var_imageSize, var_offset);
                this->glCompressedTexImage3DOffsetAEMU(this, var_target, var_level,
                                                       var_internalformat, var_width, var_height,
                                                       var_depth, var_border, var_imageSize,
                                                       var_offset);
            ...
            case OP_glCompressedTexSubImage3D: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glCompressedTexSubImage3D\n", err);
#endif
                DEBUG("gles2(%p): glCompressedTexSubImage3D(0x%08x %d %d %d %d %d %d %d 0x%08x %d %p(%u) )\n",
                      stream, var_target, var_level, var_xoffset, var_yoffset, var_zoffset,
                      var_width, var_height, var_depth, var_format, var_imageSize,
                      (const GLvoid *) (inptr_data.get()), size_data);
                this->glCompressedTexSubImage3D(var_target, var_level, var_xoffset, var_yoffset,
                                                var_zoffset, var_width, var_height, var_depth,
                                                var_format, var_imageSize, size_data == 0 ? nullptr
                                                                                          : (const GLvoid *) (inptr_data.get()));
            ...
            case OP_glCompressedTexSubImage3DOffsetAEMU: {
                ...
                GLsizei var_imageSize = Unpack<GLsizei, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4);
                GLuint var_data = Unpack<GLuint, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 + 4 +
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glCompressedTexSubImage3DOffsetAEMU\n",
                            err);
#endif
                DEBUG("gles2(%p): glCompressedTexSubImage3DOffsetAEMU(0x%08x %d %d %d %d %d %d %d 0x%08x %d %u )\n",
                      stream, var_target, var_level, var_xoffset, var_yoffset, var_zoffset,
                      var_width, var_height, var_depth, var_format, var_imageSize, var_data);
                this->glCompressedTexSubImage3DOffsetAEMU(this, var_target, var_level, var_xoffset,
                                                          var_yoffset, var_zoffset, var_width,
                                                          var_height, var_depth, var_format,
            ...
            case OP_glCopyTexSubImage3D: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glCopyTexSubImage3D\n",
                            err);
#endif
                DEBUG("gles2(%p): glCopyTexSubImage3D(0x%08x %d %d %d %d %d %d %d %d )\n", stream,
                      var_target, var_level, var_xoffset, var_yoffset, var_zoffset, var_x, var_y,
                      var_width, var_height);
                this->glCopyTexSubImage3D(var_target, var_level, var_xoffset, var_yoffset,
                                          var_zoffset, var_x, var_y, var_width, var_height);
            ...
            case OP_glGetBooleani_v: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetBooleani_v\n", err);
#endif
                DEBUG("gles2(%p): glGetBooleani_v(0x%08x %u %p(%u) )\n", stream, var_target,
                      var_index, (GLboolean *) (outptr_data.get()), size_data);
            ...
            case OP_glMemoryBarrier: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glMemoryBarrier\n", err);
#endif
            ...
            case OP_glMemoryBarrierByRegion: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glMemoryBarrierByRegion\n",
                            err);
#endif
            ...
            case OP_glGenProgramPipelines: {
                GLsizei var_n = Unpack<GLsizei, uint32_t>(ptr + 8);
                uint32_t size_pipelines __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr, 8 + 4 + 4,
                                                             ptr + 8 + 4 + 4, checksumSize,
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGenProgramPipelines\n",
                            err);
#endif
                DEBUG("gles2(%p): glGenProgramPipelines(%d %p(%u) )\n", stream, var_n,
                      (GLuint *) (outptr_pipelines.get()), size_pipelines);
            ...
            case OP_glDeleteProgramPipelines: {
                ...
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + size_pipelines,
                                                             ptr + 8 + 4 + 4 + size_pipelines,
                                                             checksumSize,
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glDeleteProgramPipelines\n", err);
#endif
                DEBUG("gles2(%p): glDeleteProgramPipelines(%d %p(%u) )\n", stream, var_n,
                      (const GLuint *) (inptr_pipelines.get()), size_pipelines);
                this->glDeleteProgramPipelines_dec(this, var_n,
                                                   (const GLuint *) (inptr_pipelines.get()));
            ...
            case OP_glBindProgramPipeline: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glBindProgramPipeline\n",
                            err);
#endif
            ...
            case OP_glGetProgramPipelineiv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetProgramPipelineiv\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetProgramPipelineiv(%u 0x%08x %p(%u) )\n", stream,
                      var_pipeline, var_pname, (GLint *) (outptr_params.get()), size_params);
                this->glGetProgramPipelineiv(var_pipeline, var_pname,
                                             (GLint *) (outptr_params.get()));
                outptr_params.flush();
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
            ...
            case OP_glGetProgramPipelineInfoLog: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetProgramPipelineInfoLog\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetProgramPipelineInfoLog(%u %d %p(%u) %p(%u) )\n", stream,
                      var_pipeline, var_bufSize, (GLsizei *) (outptr_length.get()), size_length,
                      (GLchar *) (outptr_infoLog.get()), size_infoLog);
                this->glGetProgramPipelineInfoLog(var_pipeline, var_bufSize,
                                                  size_length == 0 ? nullptr
                                                                   : (GLsizei *) (outptr_length.get()),
                                                  (GLchar *) (outptr_infoLog.get()));
                outptr_length.flush();
            ...
            case OP_glValidateProgramPipeline: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glValidateProgramPipeline\n", err);
#endif
            ...
            case OP_glIsProgramPipeline: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glIsProgramPipeline\n",
                            err);
#endif
            ...
            case OP_glUseProgramStages: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glUseProgramStages\n",
                            err);
#endif
                DEBUG("gles2(%p): glUseProgramStages(%u 0x%08x %u )\n", stream, var_pipeline,
                      var_stages, var_program);
            ...
            case OP_glActiveShaderProgram: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glActiveShaderProgram\n",
                            err);
#endif
            ...
            case OP_glCreateShaderProgramv: {
                GLenum var_type = Unpack<GLenum, uint32_t>(ptr + 8);
                GLsizei var_count = Unpack<GLsizei, uint32_t>(ptr + 8 + 4);
                uint32_t size_strings __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4);
                InputBuffer inptr_strings(ptr + 8 + 4 + 4 + 4, size_strings);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + size_strings,
                                                             ptr + 8 + 4 + 4 + 4 + size_strings,
                                                             checksumSize,
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glCreateShaderProgramv\n",
                            err);
#endif
                DEBUG("gles2(%p): glCreateShaderProgramv(0x%08x %d %p(%u) )\n", stream, var_type,
                      var_count, (const char **) (inptr_strings.get()), size_strings);
                *(GLuint *) (&tmpBuf[0]) = this->glCreateShaderProgramv(var_type, var_count,
                                                                        (const char **) (inptr_strings.get()));
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
                                                                totalTmpSize - checksumSize,
                                                                &tmpBuf[totalTmpSize -
            ...
            case OP_glCreateShaderProgramvAEMU: {
                GLenum var_type = Unpack<GLenum, uint32_t>(ptr + 8);
                GLsizei var_count = Unpack<GLsizei, uint32_t>(ptr + 8 + 4);
                uint32_t size_packedStrings __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4);
                InputBuffer inptr_packedStrings(ptr + 8 + 4 + 4 + 4, size_packedStrings);
                GLuint var_packedLen = Unpack<GLuint, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + size_packedStrings);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + size_packedStrings + 4,
                                                             ptr + 8 + 4 + 4 + 4 +
                                                             size_packedStrings + 4, checksumSize,
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glCreateShaderProgramvAEMU\n",
                            err);
#endif
                DEBUG("gles2(%p): glCreateShaderProgramvAEMU(0x%08x %d %p(%u) %u )\n", stream,
                      var_type, var_count, (const char *) (inptr_packedStrings.get()),
                      size_packedStrings, var_packedLen);
                *(GLuint *) (&tmpBuf[0]) = this->glCreateShaderProgramvAEMU(this, var_type,
                                                                            var_count,
                                                                            (const char *) (inptr_packedStrings.get()),
                                                                            var_packedLen);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
                                                                totalTmpSize - checksumSize,
            ...
            case OP_glProgramUniform1f: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform1f\n",
                            err);
#endif
            ...
            case OP_glProgramUniform2f: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform2f\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniform2f(%u %d %f %f )\n", stream, var_program,
                      var_location, var_v0, var_v1);
            ...
            case OP_glProgramUniform3f: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform3f\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniform3f(%u %d %f %f %f )\n", stream, var_program,
                      var_location, var_v0, var_v1, var_v2);
                this->glProgramUniform3f_dec(this, var_program, var_location, var_v0, var_v1,
                                             var_v2);
            ...
            case OP_glProgramUniform4f: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform4f\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniform4f(%u %d %f %f %f %f )\n", stream, var_program,
                      var_location, var_v0, var_v1, var_v2, var_v3);
                this->glProgramUniform4f_dec(this, var_program, var_location, var_v0, var_v1,
                                             var_v2, var_v3);
            ...
            case OP_glProgramUniform1i: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform1i\n",
                            err);
#endif
            ...
            case OP_glProgramUniform2i: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform2i\n",
                            err);
#endif
            ...
            case OP_glProgramUniform3i: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform3i\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniform3i(%u %d %d %d %d )\n", stream, var_program,
                      var_location, var_v0, var_v1, var_v2);
                this->glProgramUniform3i_dec(this, var_program, var_location, var_v0, var_v1,
                                             var_v2);
            ...
            case OP_glProgramUniform4i: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform4i\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniform4i(%u %d %d %d %d %d )\n", stream, var_program,
                      var_location, var_v0, var_v1, var_v2, var_v3);
                this->glProgramUniform4i_dec(this, var_program, var_location, var_v0, var_v1,
                                             var_v2, var_v3);
            ...
            case OP_glProgramUniform1ui: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform1ui\n",
                            err);
#endif
            ...
            case OP_glProgramUniform2ui: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform2ui\n",
                            err);
#endif
            ...
            case OP_glProgramUniform3ui: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform3ui\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniform3ui(%u %d %d %d %u )\n", stream, var_program,
                      var_location, var_v0, var_v1, var_v2);
                this->glProgramUniform3ui_dec(this, var_program, var_location, var_v0, var_v1,
                                              var_v2);
            ...
            case OP_glProgramUniform4ui: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform4ui\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniform4ui(%u %d %d %d %d %u )\n", stream, var_program,
                      var_location, var_v0, var_v1, var_v2, var_v3);
                this->glProgramUniform4ui_dec(this, var_program, var_location, var_v0, var_v1,
                                              var_v2, var_v3);
            ...
            case OP_glProgramUniform1fv: {
                ...
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + 4 + size_value,
                                                             ptr + 8 + 4 + 4 + 4 + 4 + size_value,
                                                             checksumSize,
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform1fv\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniform1fv(%u %d %d %p(%u) )\n", stream, var_program,
                      var_location, var_count, (const GLfloat *) (inptr_value.get()), size_value);
                this->glProgramUniform1fv_dec(this, var_program, var_location, var_count,
                                              (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glProgramUniform2fv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform2fv\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniform2fv(%u %d %d %p(%u) )\n", stream, var_program,
                      var_location, var_count, (const GLfloat *) (inptr_value.get()), size_value);
                this->glProgramUniform2fv_dec(this, var_program, var_location, var_count,
                                              (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glProgramUniform3fv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform3fv\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniform3fv(%u %d %d %p(%u) )\n", stream, var_program,
                      var_location, var_count, (const GLfloat *) (inptr_value.get()), size_value);
                this->glProgramUniform3fv_dec(this, var_program, var_location, var_count,
                                              (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glProgramUniform4fv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform4fv\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniform4fv(%u %d %d %p(%u) )\n", stream, var_program,
                      var_location, var_count, (const GLfloat *) (inptr_value.get()), size_value);
                this->glProgramUniform4fv_dec(this, var_program, var_location, var_count,
                                              (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glProgramUniform1iv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform1iv\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniform1iv(%u %d %d %p(%u) )\n", stream, var_program,
                      var_location, var_count, (const GLint *) (inptr_value.get()), size_value);
                this->glProgramUniform1iv_dec(this, var_program, var_location, var_count,
                                              (const GLint *) (inptr_value.get()));
            ...
            case OP_glProgramUniform2iv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform2iv\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniform2iv(%u %d %d %p(%u) )\n", stream, var_program,
                      var_location, var_count, (const GLint *) (inptr_value.get()), size_value);
                this->glProgramUniform2iv_dec(this, var_program, var_location, var_count,
                                              (const GLint *) (inptr_value.get()));
            ...
            case OP_glProgramUniform3iv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform3iv\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniform3iv(%u %d %d %p(%u) )\n", stream, var_program,
                      var_location, var_count, (const GLint *) (inptr_value.get()), size_value);
                this->glProgramUniform3iv_dec(this, var_program, var_location, var_count,
                                              (const GLint *) (inptr_value.get()));
            ...
            case OP_glProgramUniform4iv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform4iv\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniform4iv(%u %d %d %p(%u) )\n", stream, var_program,
                      var_location, var_count, (const GLint *) (inptr_value.get()), size_value);
                this->glProgramUniform4iv_dec(this, var_program, var_location, var_count,
                                              (const GLint *) (inptr_value.get()));
            ...
            case OP_glProgramUniform1uiv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform1uiv\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniform1uiv(%u %d %d %p(%u) )\n", stream, var_program,
                      var_location, var_count, (const GLuint *) (inptr_value.get()), size_value);
                this->glProgramUniform1uiv_dec(this, var_program, var_location, var_count,
                                               (const GLuint *) (inptr_value.get()));
            ...
            case OP_glProgramUniform2uiv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform2uiv\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniform2uiv(%u %d %d %p(%u) )\n", stream, var_program,
                      var_location, var_count, (const GLuint *) (inptr_value.get()), size_value);
                this->glProgramUniform2uiv_dec(this, var_program, var_location, var_count,
                                               (const GLuint *) (inptr_value.get()));
            ...
            case OP_glProgramUniform3uiv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform3uiv\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniform3uiv(%u %d %d %p(%u) )\n", stream, var_program,
                      var_location, var_count, (const GLuint *) (inptr_value.get()), size_value);
                this->glProgramUniform3uiv_dec(this, var_program, var_location, var_count,
                                               (const GLuint *) (inptr_value.get()));
            ...
            case OP_glProgramUniform4uiv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glProgramUniform4uiv\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniform4uiv(%u %d %d %p(%u) )\n", stream, var_program,
                      var_location, var_count, (const GLuint *) (inptr_value.get()), size_value);
                this->glProgramUniform4uiv_dec(this, var_program, var_location, var_count,
                                               (const GLuint *) (inptr_value.get()));
            ...
            case OP_glProgramUniformMatrix2fv: {
                ...
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + 1 + 4 + size_value,
                                                             ptr + 8 + 4 + 4 + 4 + 1 + 4 +
                                                             size_value, checksumSize,
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glProgramUniformMatrix2fv\n", err);
#endif
                DEBUG("gles2(%p): glProgramUniformMatrix2fv(%u %d %d %d %p(%u) )\n", stream,
                      var_program, var_location, var_count, var_transpose,
                      (const GLfloat *) (inptr_value.get()), size_value);
                this->glProgramUniformMatrix2fv_dec(this, var_program, var_location, var_count,
                                                    var_transpose,
                                                    (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glProgramUniformMatrix3fv: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glProgramUniformMatrix3fv\n", err);
#endif
                DEBUG("gles2(%p): glProgramUniformMatrix3fv(%u %d %d %d %p(%u) )\n", stream,
                      var_program, var_location, var_count, var_transpose,
                      (const GLfloat *) (inptr_value.get()), size_value);
                this->glProgramUniformMatrix3fv_dec(this, var_program, var_location, var_count,
                                                    var_transpose,
                                                    (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glProgramUniformMatrix4fv: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glProgramUniformMatrix4fv\n", err);
#endif
                DEBUG("gles2(%p): glProgramUniformMatrix4fv(%u %d %d %d %p(%u) )\n", stream,
                      var_program, var_location, var_count, var_transpose,
                      (const GLfloat *) (inptr_value.get()), size_value);
                this->glProgramUniformMatrix4fv_dec(this, var_program, var_location, var_count,
                                                    var_transpose,
                                                    (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glProgramUniformMatrix2x3fv: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glProgramUniformMatrix2x3fv\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniformMatrix2x3fv(%u %d %d %d %p(%u) )\n", stream,
                      var_program, var_location, var_count, var_transpose,
                      (const GLfloat *) (inptr_value.get()), size_value);
                this->glProgramUniformMatrix2x3fv_dec(this, var_program, var_location, var_count,
                                                      var_transpose,
                                                      (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glProgramUniformMatrix3x2fv: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glProgramUniformMatrix3x2fv\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniformMatrix3x2fv(%u %d %d %d %p(%u) )\n", stream,
                      var_program, var_location, var_count, var_transpose,
                      (const GLfloat *) (inptr_value.get()), size_value);
                this->glProgramUniformMatrix3x2fv_dec(this, var_program, var_location, var_count,
                                                      var_transpose,
                                                      (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glProgramUniformMatrix2x4fv: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glProgramUniformMatrix2x4fv\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniformMatrix2x4fv(%u %d %d %d %p(%u) )\n", stream,
                      var_program, var_location, var_count, var_transpose,
                      (const GLfloat *) (inptr_value.get()), size_value);
                this->glProgramUniformMatrix2x4fv_dec(this, var_program, var_location, var_count,
                                                      var_transpose,
                                                      (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glProgramUniformMatrix4x2fv: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glProgramUniformMatrix4x2fv\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniformMatrix4x2fv(%u %d %d %d %p(%u) )\n", stream,
                      var_program, var_location, var_count, var_transpose,
                      (const GLfloat *) (inptr_value.get()), size_value);
                this->glProgramUniformMatrix4x2fv_dec(this, var_program, var_location, var_count,
                                                      var_transpose,
                                                      (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glProgramUniformMatrix3x4fv: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glProgramUniformMatrix3x4fv\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniformMatrix3x4fv(%u %d %d %d %p(%u) )\n", stream,
                      var_program, var_location, var_count, var_transpose,
                      (const GLfloat *) (inptr_value.get()), size_value);
                this->glProgramUniformMatrix3x4fv_dec(this, var_program, var_location, var_count,
                                                      var_transpose,
                                                      (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glProgramUniformMatrix4x3fv: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glProgramUniformMatrix4x3fv\n",
                            err);
#endif
                DEBUG("gles2(%p): glProgramUniformMatrix4x3fv(%u %d %d %d %p(%u) )\n", stream,
                      var_program, var_location, var_count, var_transpose,
                      (const GLfloat *) (inptr_value.get()), size_value);
                this->glProgramUniformMatrix4x3fv_dec(this, var_program, var_location, var_count,
                                                      var_transpose,
                                                      (const GLfloat *) (inptr_value.get()));
            ...
            case OP_glGetProgramInterfaceiv: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetProgramInterfaceiv\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetProgramInterfaceiv(%u 0x%08x 0x%08x %p(%u) )\n", stream,
                      var_program, var_programInterface, var_pname, (GLint *) (outptr_params.get()),
                      size_params);
                this->glGetProgramInterfaceiv_dec(this, var_program, var_programInterface,
                                                  var_pname, (GLint *) (outptr_params.get()));
                outptr_params.flush();
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
            ...
            case OP_glGetProgramResourceiv: {
                ...
                uint32_t size_props __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4);
                InputBuffer inptr_props(ptr + 8 + 4 + 4 + 4 + 4 + 4, size_props);
                GLsizei var_bufSize = Unpack<GLsizei, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4 + 4 + size_props);
                uint32_t size_length __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4 + 4 + size_props + 4);
                uint32_t size_params __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4 + 4 + 4 + 4 + size_props + 4 + 4);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + 4 + 4 + size_props +
                                                             4 + 4 + 4,
                                                             ptr + 8 + 4 + 4 + 4 + 4 + 4 +
                                                             size_props + 4 + 4 + 4, checksumSize,
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetProgramResourceiv\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetProgramResourceiv(%u 0x%08x %u %d %p(%u) %d %p(%u) %p(%u) )\n",
                      stream, var_program, var_programInterface, var_index, var_propCount,
                      (const GLenum *) (inptr_props.get()), size_props, var_bufSize,
                      (GLsizei *) (outptr_length.get()), size_length,
                      (GLint *) (outptr_params.get()), size_params);
                this->glGetProgramResourceiv_dec(this, var_program, var_programInterface, var_index,
                                                 var_propCount,
                                                 (const GLenum *) (inptr_props.get()), var_bufSize,
                                                 size_length == 0 ? nullptr
                                                                  : (GLsizei *) (outptr_length.get()),
                                                 (GLint *) (outptr_params.get()));
                outptr_length.flush();
            ...
            case OP_glGetProgramResourceIndex: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetProgramResourceIndex\n", err);
#endif
                DEBUG("gles2(%p): glGetProgramResourceIndex(%u 0x%08x %p(%u) )\n", stream,
                      var_program, var_programInterface, (const char *) (inptr_name.get()),
                      size_name);
                *(GLuint *) (&tmpBuf[0]) = this->glGetProgramResourceIndex_dec(this, var_program,
                                                                               var_programInterface,
                                                                               (const char *) (inptr_name.get()));
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
                                                                totalTmpSize - checksumSize,
            ...
            case OP_glGetProgramResourceLocation: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetProgramResourceLocation\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetProgramResourceLocation(%u 0x%08x %p(%u) )\n", stream,
                      var_program, var_programInterface, (const char *) (inptr_name.get()),
                      size_name);
                *(GLint *) (&tmpBuf[0]) = this->glGetProgramResourceLocation_dec(this, var_program,
                                                                                 var_programInterface,
                                                                                 (const char *) (inptr_name.get()));
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
            ...
            case OP_glGetProgramResourceName: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetProgramResourceName\n", err);
#endif
                DEBUG("gles2(%p): glGetProgramResourceName(%u 0x%08x %u %d %p(%u) %p(%u) )\n",
                      stream, var_program, var_programInterface, var_index, var_bufSize,
                      (GLsizei *) (outptr_length.get()), size_length, (char *) (outptr_name.get()),
                      size_name);
                this->glGetProgramResourceName_dec(this, var_program, var_programInterface,
                                                   var_index, var_bufSize,
                                                   size_length == 0 ? nullptr
                                                                    : (GLsizei *) (outptr_length.get()),
                                                   (char *) (outptr_name.get()));
                outptr_length.flush();
            ...
            case OP_glBindImageTexture: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glBindImageTexture\n",
                            err);
#endif
                DEBUG("gles2(%p): glBindImageTexture(%u %u %d %d %d 0x%08x 0x%08x )\n", stream,
                      var_unit, var_texture, var_level, var_layered, var_layer, var_access,
                      var_format);
                this->glBindImageTexture(var_unit, var_texture, var_level, var_layered, var_layer,
                                         var_access, var_format);
            ...
            case OP_glDispatchCompute: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDispatchCompute\n", err);
#endif
                DEBUG("gles2(%p): glDispatchCompute(%u %u %u )\n", stream, var_num_groups_x,
                      var_num_groups_y, var_num_groups_z);
            ...
            case OP_glDispatchComputeIndirect: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glDispatchComputeIndirect\n", err);
#endif
            ...
            case OP_glBindVertexBuffer: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glBindVertexBuffer\n",
                            err);
#endif
                DEBUG("gles2(%p): glBindVertexBuffer(%u %u 0x%08lx 0x%08lx )\n", stream,
                      var_bindingindex, var_buffer, var_offset, var_stride);
            ...
            case OP_glVertexAttribBinding: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glVertexAttribBinding\n",
                            err);
#endif
                DEBUG("gles2(%p): glVertexAttribBinding(%u %u )\n", stream, var_attribindex,
                      var_bindingindex);
            ...
            case OP_glVertexAttribFormat: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glVertexAttribFormat\n",
                            err);
#endif
                DEBUG("gles2(%p): glVertexAttribFormat(%u %d 0x%08x %d %u )\n", stream,
                      var_attribindex, var_size, var_type, var_normalized, var_relativeoffset);
            ...
            case OP_glVertexAttribIFormat: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glVertexAttribIFormat\n",
                            err);
#endif
                DEBUG("gles2(%p): glVertexAttribIFormat(%u %d 0x%08x %u )\n", stream,
                      var_attribindex, var_size, var_type, var_relativeoffset);
                this->glVertexAttribIFormat(var_attribindex, var_size, var_type,
                                            var_relativeoffset);
            ...
            case OP_glVertexBindingDivisor: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glVertexBindingDivisor\n",
                            err);
#endif
                DEBUG("gles2(%p): glVertexBindingDivisor(%u %u )\n", stream, var_bindingindex,
                      var_divisor);
            ...
            case OP_glDrawArraysIndirect: {
                GLenum var_mode = Unpack<GLenum, uint32_t>(ptr + 8);
                uint32_t size_indirect __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4);
                InputBuffer inptr_indirect(ptr + 8 + 4 + 4, size_indirect);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + size_indirect,
                                                             ptr + 8 + 4 + 4 + size_indirect,
                                                             checksumSize,
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDrawArraysIndirect\n",
                            err);
#endif
                DEBUG("gles2(%p): glDrawArraysIndirect(0x%08x %p(%u) )\n", stream, var_mode,
                      (const void *) (inptr_indirect.get()), size_indirect);
            ...
            case OP_glDrawArraysIndirectDataAEMU: {
                ...
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + size_indirect + 4,
                                                             ptr + 8 + 4 + 4 + size_indirect + 4,
                                                             checksumSize,
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glDrawArraysIndirectDataAEMU\n",
                            err);
#endif
                DEBUG("gles2(%p): glDrawArraysIndirectDataAEMU(0x%08x %p(%u) %u )\n", stream,
                      var_mode, (const void *) (inptr_indirect.get()), size_indirect, var_datalen);
                this->glDrawArraysIndirectDataAEMU(this, var_mode,
                                                   (const void *) (inptr_indirect.get()),
                                                   var_datalen);
            ...
            case OP_glDrawArraysIndirectOffsetAEMU: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glDrawArraysIndirectOffsetAEMU\n",
                            err);
#endif
            ...
            case OP_glDrawElementsIndirect: {
                ...
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + size_indirect,
                                                             ptr + 8 + 4 + 4 + 4 + size_indirect,
                                                             checksumSize,
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glDrawElementsIndirect\n",
                            err);
#endif
                DEBUG("gles2(%p): glDrawElementsIndirect(0x%08x 0x%08x %p(%u) )\n", stream,
                      var_mode, var_type, (const void *) (inptr_indirect.get()), size_indirect);
                this->glDrawElementsIndirect(var_mode, var_type,
                                             (const void *) (inptr_indirect.get()));
            ...
            case OP_glDrawElementsIndirectDataAEMU: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glDrawElementsIndirectDataAEMU\n",
                            err);
#endif
                DEBUG("gles2(%p): glDrawElementsIndirectDataAEMU(0x%08x 0x%08x %p(%u) %u )\n",
                      stream, var_mode, var_type, (const void *) (inptr_indirect.get()),
                      size_indirect, var_datalen);
                this->glDrawElementsIndirectDataAEMU(this, var_mode, var_type,
                                                     (const void *) (inptr_indirect.get()),
                                                     var_datalen);
            ...
            case OP_glDrawElementsIndirectOffsetAEMU: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glDrawElementsIndirectOffsetAEMU\n",
                            err);
#endif
                DEBUG("gles2(%p): glDrawElementsIndirectOffsetAEMU(0x%08x 0x%08x %u )\n", stream,
                      var_mode, var_type, var_offset);
            ...
            case OP_glTexStorage2DMultisample: {
                ...
                GLsizei var_width = Unpack<GLsizei, uint32_t>(ptr + 8 + 4 + 4 + 4);
                GLsizei var_height = Unpack<GLsizei, uint32_t>(ptr + 8 + 4 + 4 + 4 + 4);
                GLboolean var_fixedsamplelocations = Unpack<GLboolean, uint8_t>(
                        ptr + 8 + 4 + 4 + 4 + 4 + 4);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr,
                                                             8 + 4 + 4 + 4 + 4 + 4 + 1,
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glTexStorage2DMultisample\n", err);
#endif
                ...
                this->glTexStorage2DMultisample(var_target, var_samples, var_internalformat,
                                                var_width, var_height, var_fixedsamplelocations);
            ...
            case OP_glSampleMaski: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glSampleMaski\n", err);
#endif
            ...
            case OP_glGetMultisamplefv: {
                GLenum var_pname = Unpack<GLenum, uint32_t>(ptr + 8);
                GLuint var_index = Unpack<GLuint, uint32_t>(ptr + 8 + 4);
                uint32_t size_val __attribute__((unused)) = Unpack<uint32_t, uint32_t>(
                        ptr + 8 + 4 + 4);
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::validOrDie(checksumCalc, ptr, 8 + 4 + 4 + 4,
                                                             ptr + 8 + 4 + 4 + 4, checksumSize,
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glGetMultisamplefv\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetMultisamplefv(0x%08x %u %p(%u) )\n", stream, var_pname,
                      var_index, (GLfloat *) (outptr_val.get()), size_val);
            ...
            case OP_glFramebufferParameteri: {
                ...
                GLint err = this->glGetError();
                if (err)
                    fprintf(stderr, "gles2 Error (pre-call): 0x%X before glFramebufferParameteri\n",
                            err);
#endif
            ...
            case OP_glGetFramebufferParameteriv: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetFramebufferParameteriv\n",
                            err);
#endif
                DEBUG("gles2(%p): glGetFramebufferParameteriv(0x%08x 0x%08x %p(%u) )\n", stream,
                      var_target, var_pname, (GLint *) (outptr_params.get()), size_params);
                this->glGetFramebufferParameteriv(var_target, var_pname,
                                                  (GLint *) (outptr_params.get()));
                outptr_params.flush();
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
            ...
            case OP_glGetTexLevelParameterfv: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetTexLevelParameterfv\n", err);
#endif
                DEBUG("gles2(%p): glGetTexLevelParameterfv(0x%08x %d 0x%08x %p(%u) )\n", stream,
                      var_target, var_level, var_pname, (GLfloat *) (outptr_params.get()),
                      size_params);
                this->glGetTexLevelParameterfv(var_target, var_level, var_pname,
                                               (GLfloat *) (outptr_params.get()));
                outptr_params.flush();
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
            ...
            case OP_glGetTexLevelParameteriv: {
                ...
                if (err)
                    fprintf(stderr,
                            "gles2 Error (pre-call): 0x%X before glGetTexLevelParameteriv\n", err);
#endif
                DEBUG("gles2(%p): glGetTexLevelParameteriv(0x%08x %d 0x%08x %p(%u) )\n", stream,
                      var_target, var_level, var_pname, (GLint *) (outptr_params.get()),
                      size_params);
                this->glGetTexLevelParameteriv(var_target, var_level, var_pname,
                                               (GLint *) (outptr_params.get()));
                outptr_params.flush();
                if (useChecksum) {
                    ChecksumCalculatorThreadInfo::writeChecksum(checksumCalc, &tmpBuf[0],
...
#if LOG_CALL_NAME
                                                                                                                                if (strlen(lastCall))
            ALOGE("xxx gles2 call %s", lastCall);
#endif
        GLint err = this->glGetError();
        if (err) ALOGE("gles2 Error (post-call): 0x%X in %s\n", err, lastCall);
#endif
