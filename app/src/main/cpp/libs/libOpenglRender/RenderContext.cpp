...
RenderContext* RenderContext::create(EGLDisplay display,
                                     ...
                                     HandleType hndl,
                                     GLESApi version) {
    return createImpl(display, config, sharedContext, hndl, version);
}

RenderContext * RenderContext::createImpl(EGLDisplay display, EGLConfig config,
                                          EGLContext sharedContext,
                                          HandleType hndl, GLESApi version) {
